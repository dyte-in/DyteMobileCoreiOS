...
@protocol DOSCIDyteMediaSoupClientCallback
@required
...
- (DOSCDyteMeetingInfo *)doCopyOrgId:(NSString *)orgId roomName:(NSString *)roomName authToken:(NSString *)authToken enableAudio:(BOOL)enableAudio enableVideo:(BOOL)enableVideo baseUrl:(NSString *)baseUrl displayName:(NSString *)displayName __attribute__((swift_name("doCopy(orgId:roomName:authToken:enableAudio:enableVideo:baseUrl:displayName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithId:(NSString *)id userId:(NSString *)userId name:(NSString *)name picture:(NSString * _Nullable)picture isHost:(BOOL)isHost clientSpecificId:(NSString *)clientSpecificId flags:(DOSCParticipantFlags *)flags audioEnabled:(BOOL)audioEnabled videoEnabled:(BOOL)videoEnabled controllerContainer:(id<DOSCIControllerContainer>)controllerContainer __attribute__((swift_name("init(id:userId:name:picture:isHost:clientSpecificId:flags:audioEnabled:videoEnabled:controllerContainer:)"))) __attribute__((objc_designated_initializer));
@property BOOL audioEnabled __attribute__((swift_name("audioEnabled")));
...
- (void)setPluginViewView:(WKWebView *)view __attribute__((swift_name("setPluginView(view:)")));
@property (readonly) NSString *baseURL __attribute__((swift_name("baseURL")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)votePollMessage:(DOSCDytePollMessage *)pollMessage pollOption:(DOSCDytePollOption *)pollOption error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("vote(pollMessage:pollOption:)")));
...
- (void)setModeViewMode:(DOSCPageViewMode *)viewMode __attribute__((swift_name("setMode(viewMode:)")));
...
- (DOSCDyteAudioDevice *)getSelectedDevice __attribute__((swift_name("getSelectedDevice()")));
...
@property (readonly) DOSCUserPresetModel *permission __attribute__((swift_name("permission")));
@property (readonly) NSString * _Nullable picture __attribute__((swift_name("picture")));
@property (readonly) NSString *userId __attribute__((swift_name("userId")));
@property BOOL videoEnabled __attribute__((swift_name("videoEnabled")));
@end;
...
- (instancetype)initWithId:(int32_t)id message:(NSString *)message loggedAt:(int64_t)loggedAt status:(DOSCLogStatus *)status logSeverity:(DOSCLogSeverity *)logSeverity __attribute__((swift_name("init(id:message:loggedAt:status:logSeverity:)"))) __attribute__((objc_designated_initializer));
...
- (DOSCDyteLog *)doCopyId:(int32_t)id message:(NSString *)message loggedAt:(int64_t)loggedAt status:(DOSCLogStatus *)status logSeverity:(DOSCLogSeverity *)logSeverity __attribute__((swift_name("doCopy(id:message:loggedAt:status:logSeverity:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) DOSCLogSeverity *logSeverity __attribute__((swift_name("logSeverity")));
@property (readonly) int64_t loggedAt __attribute__((swift_name("loggedAt")));
@property (readonly) NSString *message __attribute__((swift_name("message")));
...
__attribute__((swift_name("IDyteLoggerController")))
@protocol DOSCIDyteLoggerController
@required
...
- (instancetype)initWithParticipant:(DOSCDyteMeetingParticipant *)participant meetingStartedAt:(NSString *)meetingStartedAt __attribute__((swift_name("init(participant:meetingStartedAt:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) id<DOSCIDyteLoggerController> loggerController __attribute__((swift_name("loggerController")));
...
@property (readonly) NSArray<id<DOSCDyteCameraEventsListener>> *cameraEventsListeners __attribute__((swift_name("cameraEventsListeners")));
@property (readonly) NSArray<id<DOSCDyteParticipantEventsListener>> *participantEventsListeners __attribute__((swift_name("participantEventsListeners")));
@property (readonly) NSArray<id<DOSCDytePermissionEventsListener>> *permissionEventsListeners __attribute__((swift_name("permissionEventsListeners")));
@property (readonly) NSArray<id<DOSCDytePluginEventsListener>> *pluginEventsListeners __attribute__((swift_name("pluginEventsListeners")));
@property (readonly) NSArray<id<DOSCDyteMeetingRoomEventsListener>> *roomEventsListeners __attribute__((swift_name("roomEventsListeners")));
@property (readonly) NSArray<id<DOSCDyteSelfEventsListener>> *selfEventsListeners __attribute__((swift_name("selfEventsListeners")));
@end;
...
- (void)muteAudioDyteMeetingParticipant:(DOSCDyteMeetingParticipant *)dyteMeetingParticipant __attribute__((swift_name("muteAudio(dyteMeetingParticipant:)")));
- (void)muteVideoDyteMeetingParticipant:(DOSCDyteMeetingParticipant *)dyteMeetingParticipant __attribute__((swift_name("muteVideo(dyteMeetingParticipant:)")));
@end;
...
- (DOSCPageViewMode *)getViewMode __attribute__((swift_name("getViewMode()")));
...
- (void)onPeerScreenShareStartedParticipant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("onPeerScreenShareStarted(participant:)")));
...
- (void)onPeerVideoMutedWebSocketProducerClosedModel:(DOSCWebSocketProducerClosedModel *)webSocketProducerClosedModel __attribute__((swift_name("onPeerVideoMuted(webSocketProducerClosedModel:)")));
- (void)onPeerVideoUnMutedWebSocketProducerConnectModel:(DOSCWebSocketProducerConnectModel *)webSocketProducerConnectModel __attribute__((swift_name("onPeerVideoUnMuted(webSocketProducerConnectModel:)")));
...
- (void)setViewModePageViewMode:(DOSCPageViewMode *)pageViewMode __attribute__((swift_name("setViewMode(pageViewMode:)")));
...
@required
- (void)activatePluginPlugin:(DOSCDytePlugin *)plugin __attribute__((swift_name("activatePlugin(plugin:)")));
- (void)deactivatePluginPlugin:(DOSCDytePlugin *)plugin __attribute__((swift_name("deactivatePlugin(plugin:)")));
...
@property (readonly) NSArray<DOSCDytePlugin *> *plugins __attribute__((swift_name("plugins")));
@end;
...
- (void)voteDytePollMessage:(DOSCDytePollMessage *)dytePollMessage dytePollOption:(DOSCDytePollOption *)dytePollOption __attribute__((swift_name("vote(dytePollMessage:dytePollOption:)")));
@property (readonly) NSArray<DOSCDytePollMessage *> *polls __attribute__((swift_name("polls")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)startWithCompletionHandler:(void (^)(DOSCKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("start(completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)stopWithCompletionHandler:(void (^)(DOSCKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("stop(completionHandler:)")));
@end;
...
@interface DOSCPageViewMode : DOSCKotlinEnum<DOSCPageViewMode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DOSCPageViewMode *grid __attribute__((swift_name("grid")));
@property (class, readonly) DOSCPageViewMode *paginated __attribute__((swift_name("paginated")));
+ (DOSCKotlinArray<DOSCPageViewMode *> *)values __attribute__((swift_name("values()")));
@end;
...
- (DOSCDevice *)doCopyIsMobile:(DOSCBoolean * _Nullable)isMobile browserName:(NSString * _Nullable)browserName osName:(NSString * _Nullable)osName browserVersion:(NSString * _Nullable)browserVersion osVersionName:(NSString * _Nullable)osVersionName engineName:(NSString * _Nullable)engineName __attribute__((swift_name("doCopy(isMobile:browserName:osName:browserVersion:osVersionName:engineName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property DOSCBoolean * _Nullable isMobile __attribute__((swift_name("isMobile")));
...
- (instancetype)initWithId:(NSString * _Nullable)id userId:(NSString * _Nullable)userId displayName:(NSString * _Nullable)displayName device:(DOSCDevice * _Nullable)device picture:(NSString * _Nullable)picture isHost:(DOSCBoolean * _Nullable)isHost webinarHiddenParticipant:(DOSCBoolean * _Nullable)webinarHiddenParticipant flags:(DOSCMeetingPeerFlags * _Nullable)flags metadata:(DOSCMeetingPeerMetadata * _Nullable)metadata clientSpecificId:(NSString * _Nullable)clientSpecificId audioMuted:(DOSCBoolean * _Nullable)audioMuted hiddenParticipant:(DOSCBoolean * _Nullable)hiddenParticipant __attribute__((swift_name("init(id:userId:displayName:device:picture:isHost:webinarHiddenParticipant:flags:metadata:clientSpecificId:audioMuted:hiddenParticipant:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (DOSCBoolean * _Nullable)component12 __attribute__((swift_name("component12()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
...
- (DOSCMeetingPeerMetadata * _Nullable)component9 __attribute__((swift_name("component9()")));
- (DOSCWebSocketMeetingPeerUser *)doCopyId:(NSString * _Nullable)id userId:(NSString * _Nullable)userId displayName:(NSString * _Nullable)displayName device:(DOSCDevice * _Nullable)device picture:(NSString * _Nullable)picture isHost:(DOSCBoolean * _Nullable)isHost webinarHiddenParticipant:(DOSCBoolean * _Nullable)webinarHiddenParticipant flags:(DOSCMeetingPeerFlags * _Nullable)flags metadata:(DOSCMeetingPeerMetadata * _Nullable)metadata clientSpecificId:(NSString * _Nullable)clientSpecificId audioMuted:(DOSCBoolean * _Nullable)audioMuted hiddenParticipant:(DOSCBoolean * _Nullable)hiddenParticipant __attribute__((swift_name("doCopy(id:userId:displayName:device:picture:isHost:webinarHiddenParticipant:flags:metadata:clientSpecificId:audioMuted:hiddenParticipant:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property DOSCMeetingPeerMetadata * _Nullable metadata __attribute__((swift_name("metadata")));
...
@interface DOSCPeerConnectionUtils : DOSCBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getActiveRecordingWithCompletionHandler:(void (^)(DOSCRecordingResponseWrapper * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getActiveRecording(completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getRoomNodeDataWithCompletionHandler:(void (^)(DOSCMeetingSessionDataWrapper * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRoomNodeData(completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getUserDetailsWithCompletionHandler:(void (^)(DOSCUserDataWrapper * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getUserDetails(completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)startRecordingWithCompletionHandler:(void (^)(DOSCRecordingResponseWrapper * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("startRecording(completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)stopRecordingRecordingData:(DOSCRecordingData *)recordingData completionHandler:(void (^)(DOSCKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("stopRecording(recordingData:completionHandler:)")));
...
@property (class, readonly, getter=companion) DOSCAuthCompanion *companion __attribute__((swift_name("companion")));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (DOSCAuth *)doCopyUserAdded:(BOOL)userAdded authToken:(NSString *)authToken id:(NSString *)id __attribute__((swift_name("doCopy(userAdded:authToken:id:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *authToken __attribute__((swift_name("authToken")));
...
@interface DOSCAuthCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCAuthCompanion *shared __attribute__((swift_name("shared")));
- (id<DOSCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthResponse")))
@interface DOSCAuthResponse : DOSCBase
- (instancetype)initWithAuthResponse:(DOSCAuth *)authResponse __attribute__((swift_name("init(authResponse:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCAuthResponseCompanion *companion __attribute__((swift_name("companion")));
- (DOSCAuth *)component1 __attribute__((swift_name("component1()")));
- (DOSCAuthResponse *)doCopyAuthResponse:(DOSCAuth *)authResponse __attribute__((swift_name("doCopy(authResponse:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) DOSCAuth *authResponse __attribute__((swift_name("authResponse")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthResponse.Companion")))
@interface DOSCAuthResponseCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCAuthResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<DOSCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Authorization")))
@interface DOSCAuthorization : DOSCBase
...
@property (class, readonly, getter=companion) DOSCAuthorizationCompanion *companion __attribute__((swift_name("companion")));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (DOSCAuthorization *)doCopyWaitingRoom:(BOOL)waitingRoom __attribute__((swift_name("doCopy(waitingRoom:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface DOSCAuthorizationCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCAuthorizationCompanion *shared __attribute__((swift_name("shared")));
- (id<DOSCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
- (instancetype)initWithTitle:(NSString * _Nullable)title presetName:(NSString *)presetName authorization:(DOSCAuthorization *)authorization __attribute__((swift_name("init(title:presetName:authorization:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCCreateMeetingRequestCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (DOSCAuthorization *)component3 __attribute__((swift_name("component3()")));
- (DOSCCreateMeetingRequest *)doCopyTitle:(NSString * _Nullable)title presetName:(NSString *)presetName authorization:(DOSCAuthorization *)authorization __attribute__((swift_name("doCopy(title:presetName:authorization:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) DOSCAuthorization *authorization __attribute__((swift_name("authorization")));
...
- (instancetype)initWithMeeting:(DOSCMeetingResponse *)meeting __attribute__((swift_name("init(meeting:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCCreateMeetingResponseCompanion *companion __attribute__((swift_name("companion")));
- (DOSCMeetingResponse *)component1 __attribute__((swift_name("component1()")));
- (DOSCCreateMeetingResponse *)doCopyMeeting:(DOSCMeetingResponse *)meeting __attribute__((swift_name("doCopy(meeting:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) DOSCMeetingResponse *meeting __attribute__((swift_name("meeting")));
@end;
...
- (instancetype)initWithData:(DOSCCreateMeetingResponse *)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
...
- (DOSCCreateMeetingResponse *)component1 __attribute__((swift_name("component1()")));
- (DOSCCreateMeetingResponseWrapper *)doCopyData:(DOSCCreateMeetingResponse *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (DOSCCreateParticipantRequest *)doCopyClientSpecificId:(NSString *)clientSpecificId displayName:(NSString * _Nullable)displayName presetName:(NSString * _Nullable)presetName roomName:(NSString *)roomName meetingId:(NSString * _Nullable)meetingId isHost:(BOOL)isHost __attribute__((swift_name("doCopy(clientSpecificId:displayName:presetName:roomName:meetingId:isHost:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *clientSpecificId __attribute__((swift_name("clientSpecificId")));
...
- (instancetype)initWithData:(DOSCAuthResponse *)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
...
- (DOSCAuthResponse *)component1 __attribute__((swift_name("component1()")));
- (DOSCCreateParticipantResponseWrapper *)doCopyData:(DOSCAuthResponse *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) DOSCAuthResponse *data __attribute__((swift_name("data")));
@end;
...
@interface DOSCMeetingResponse : DOSCBase
...
@property (class, readonly, getter=companion) DOSCMeetingResponseCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (DOSCMeetingResponse *)doCopyId:(NSString *)id title:(NSString *)title roomName:(NSString *)roomName status:(NSString *)status createdAt:(NSString *)createdAt __attribute__((swift_name("doCopy(id:title:roomName:status:createdAt:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface DOSCMeetingResponseCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCMeetingResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<DOSCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (DOSCMeetingSessionData *)doCopyTitle:(NSString * _Nullable)title roomNodeLink:(NSString * _Nullable)roomNodeLink roomName:(NSString * _Nullable)roomName password:(NSString * _Nullable)password __attribute__((swift_name("doCopy(title:roomNodeLink:roomName:password:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithData:(DOSCMeetingSessionWrapper *)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
...
- (DOSCMeetingSessionWrapper *)component1 __attribute__((swift_name("component1()")));
- (DOSCMeetingSessionDataWrapper *)doCopyData:(DOSCMeetingSessionWrapper *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) DOSCMeetingSessionWrapper *data __attribute__((swift_name("data")));
@end;
...
@interface DOSCMeetingSessionWrapper : DOSCBase
...
@property (class, readonly, getter=companion) DOSCMeetingSessionWrapperCompanion *companion __attribute__((swift_name("companion")));
- (DOSCMeetingSessionData *)component1 __attribute__((swift_name("component1()")));
- (DOSCMeetingSessionWrapper *)doCopySession:(DOSCMeetingSessionData *)session __attribute__((swift_name("doCopy(session:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface DOSCMeetingSessionWrapperCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCMeetingSessionWrapperCompanion *shared __attribute__((swift_name("shared")));
- (id<DOSCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
@interface DOSCUserData : DOSCBase
- (instancetype)initWithId:(NSString * _Nullable)id name:(NSString * _Nullable)name email:(NSString * _Nullable)email picture:(NSString * _Nullable)picture loggedIn:(DOSCBoolean * _Nullable)loggedIn clientSpecificId:(NSString * _Nullable)clientSpecificId organizationId:(NSString * _Nullable)organizationId __attribute__((swift_name("init(id:name:email:picture:loggedIn:clientSpecificId:organizationId:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCUserDataCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
...
@property (readonly) NSString * _Nullable id __attribute__((swift_name("id")));
@property (readonly) DOSCBoolean * _Nullable loggedIn __attribute__((swift_name("loggedIn")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
...
@interface DOSCUserDataCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCUserDataCompanion *shared __attribute__((swift_name("shared")));
- (id<DOSCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
- (instancetype)initWithUser:(DOSCUserData *)user __attribute__((swift_name("init(user:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCUserDataWrapperCompanion *companion __attribute__((swift_name("companion")));
- (DOSCUserData *)component1 __attribute__((swift_name("component1()")));
- (DOSCUserDataWrapper *)doCopyUser:(DOSCUserData *)user __attribute__((swift_name("doCopy(user:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) DOSCUserData *user __attribute__((swift_name("user")));
@end;
...
@required
- (void)audioUpdateAudioEnabled:(BOOL)audioEnabled participant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("audioUpdate(audioEnabled:participant:)")));
...
- (void)onParticipantUpdatedParticipant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("onParticipantUpdated(participant:)")));
- (void)onParticipantsUpdatedParticipants:(DOSCDyteRoomParticipants *)participants isNextPagePossible:(BOOL)isNextPagePossible isPreviousPagePossible:(BOOL)isPreviousPagePossible __attribute__((swift_name("onParticipantsUpdated(participants:isNextPagePossible:isPreviousPagePossible:)")));
...
- (void)videoUpdateVideoEnabled:(BOOL)videoEnabled participant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("videoUpdate(videoEnabled:participant:)")));
@end;
...
- (DOSCProduceData *)getProduceData __attribute__((swift_name("getProduceData()")));
...
- (instancetype)initWithMediaSoupClientCallback:(id<DOSCIDyteMediaSoupClientCallback>)mediaSoupClientCallback __attribute__((swift_name("init(mediaSoupClientCallback:)"))) __attribute__((objc_designated_initializer));
- (void)connectTransportId:(NSString *)id producing:(BOOL)producing onDone:(void (^)(void))onDone __attribute__((swift_name("connectTransport(id:producing:onDone:)")));
- (void)createWebRtcTransportProdModel:(DOSCWebRtcCreateTransportModel *)model iceServers:(NSArray<DOSCIceServerData *> *)iceServers __attribute__((swift_name("createWebRtcTransportProd(model:iceServers:)")));
- (void)createWebRtcTransportRecvModel:(DOSCWebRtcCreateTransportModel *)model iceServers:(NSArray<DOSCIceServerData *> *)iceServers __attribute__((swift_name("createWebRtcTransportRecv(model:iceServers:)")));
- (DOSCConsumerAppData * _Nullable)getAppDataFromConsumerIdConsumerId:(NSString *)consumerId __attribute__((swift_name("getAppDataFromConsumerId(consumerId:)")));
...
- (void)doInitControllerContainer:(id<DOSCIControllerContainer>)controllerContainer mediaSoupClientCallback:(id<DOSCIDyteMediaSoupClientCallback>)mediaSoupClientCallback __attribute__((swift_name("doInit(controllerContainer:mediaSoupClientCallback:)")));
@end;
...
@interface DOSCKotlinUnsupportedOperationException : DOSCKotlinRuntimeException
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(DOSCKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (DOSCKtor_httpHeaderValueParam *)doCopyName:(NSString *)name value:(NSString *)value __attribute__((swift_name("doCopy(name:value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
