...
- (instancetype)initWithRoomName:(NSString *)roomName authToken:(NSString *)authToken displayName:(NSString *)displayName enableAudio:(BOOL)enableAudio enableVideo:(BOOL)enableVideo baseUrl:(NSString *)baseUrl __attribute__((swift_name("init(roomName:authToken:displayName:enableAudio:enableVideo:baseUrl:)"))) __attribute__((objc_designated_initializer));
...
- (DOSCDyteMeetingInfo *)doCopyRoomName:(NSString *)roomName authToken:(NSString *)authToken displayName:(NSString *)displayName enableAudio:(BOOL)enableAudio enableVideo:(BOOL)enableVideo baseUrl:(NSString *)baseUrl __attribute__((swift_name("doCopy(roomName:authToken:displayName:enableAudio:enableVideo:baseUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)activateAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("activate()")));

/**
 @note This method converts instances of UnsupportedOperationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)deactivateAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("deactivate()")));
...
- (BOOL)canGoNextPage __attribute__((swift_name("canGoNextPage()")));
- (BOOL)canGoPreviousPage __attribute__((swift_name("canGoPreviousPage()")));
...
- (int32_t)getPageCount __attribute__((swift_name("getPageCount()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
...
- (DOSCDyteMeetingParticipant * _Nullable)pinnedParticipant __attribute__((swift_name("pinnedParticipant()")));
...
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (DOSCDevice * _Nullable)component5 __attribute__((swift_name("component5()")));
- (NSString * _Nullable)component6 __attribute__((swift_name("component6()")));
- (DOSCBoolean * _Nullable)component7 __attribute__((swift_name("component7()")));
- (DOSCBoolean * _Nullable)component8 __attribute__((swift_name("component8()")));
- (DOSCMeetingPeerFlags * _Nullable)component9 __attribute__((swift_name("component9()")));
- (DOSCWebSocketMeetingPeerUser *)doCopyId:(NSString * _Nullable)id userId:(NSString * _Nullable)userId displayName:(NSString * _Nullable)displayName name:(NSString * _Nullable)name device:(DOSCDevice * _Nullable)device picture:(NSString * _Nullable)picture isHost:(DOSCBoolean * _Nullable)isHost webinarHiddenParticipant:(DOSCBoolean * _Nullable)webinarHiddenParticipant flags:(DOSCMeetingPeerFlags * _Nullable)flags clientSpecificId:(NSString * _Nullable)clientSpecificId audioMuted:(DOSCBoolean * _Nullable)audioMuted hiddenParticipant:(DOSCBoolean * _Nullable)hiddenParticipant __attribute__((swift_name("doCopy(id:userId:displayName:name:device:picture:isHost:webinarHiddenParticipant:flags:clientSpecificId:audioMuted:hiddenParticipant:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithShowParticipantList:(BOOL)showParticipantList hostPermissions:(DOSCHostPermissions *)hostPermissions pluginPermissions:(DOSCPluginPermissions *)pluginPermissions pollPermissions:(DOSCPollPermissions *)pollPermissions mediaPermissions:(DOSCMediaPermissions *)mediaPermissions chatPermission:(DOSCChatPermissions *)chatPermission __attribute__((swift_name("init(showParticipantList:hostPermissions:pluginPermissions:pollPermissions:mediaPermissions:chatPermission:)"))) __attribute__((objc_designated_initializer));
...
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (DOSCHostPermissions *)component2 __attribute__((swift_name("component2()")));
- (DOSCPluginPermissions *)component3 __attribute__((swift_name("component3()")));
- (DOSCPollPermissions *)component4 __attribute__((swift_name("component4()")));
- (DOSCMediaPermissions *)component5 __attribute__((swift_name("component5()")));
- (DOSCChatPermissions *)component6 __attribute__((swift_name("component6()")));
- (DOSCParticipantPermissions *)doCopyShowParticipantList:(BOOL)showParticipantList hostPermissions:(DOSCHostPermissions *)hostPermissions pluginPermissions:(DOSCPluginPermissions *)pluginPermissions pollPermissions:(DOSCPollPermissions *)pollPermissions mediaPermissions:(DOSCMediaPermissions *)mediaPermissions chatPermission:(DOSCChatPermissions *)chatPermission __attribute__((swift_name("doCopy(showParticipantList:hostPermissions:pluginPermissions:pollPermissions:mediaPermissions:chatPermission:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithViewType:(NSString *)viewType name:(NSString *)name waitingRoomType:(DOSCWaitingRoomType_ *)waitingRoomType permissions:(DOSCParticipantPermissions *)permissions __attribute__((swift_name("init(viewType:name:waitingRoomType:permissions:)"))) __attribute__((objc_designated_initializer));
...
- (DOSCParticipantPermissions *)component4 __attribute__((swift_name("component4()")));
- (DOSCPresetInfo *)doCopyViewType:(NSString *)viewType name:(NSString *)name waitingRoomType:(DOSCWaitingRoomType_ *)waitingRoomType permissions:(DOSCParticipantPermissions *)permissions __attribute__((swift_name("doCopy(viewType:name:waitingRoomType:permissions:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
