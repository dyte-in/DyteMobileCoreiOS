...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingInfo")))
@interface DOSCMeetingInfo : DOSCBase
- (instancetype)initWithAuthToken:(NSString *)authToken config:(DOSCMeetingConfig *)config __attribute__((swift_name("init(authToken:config:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCMeetingInfoCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (DOSCMeetingConfig *)component2 __attribute__((swift_name("component2()")));
- (DOSCMeetingInfo *)doCopyAuthToken:(NSString *)authToken config:(DOSCMeetingConfig *)config __attribute__((swift_name("doCopy(authToken:config:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSString *)getBaseUrl __attribute__((swift_name("getBaseUrl()")));
- (NSString *)getRoomName __attribute__((swift_name("getRoomName()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *authToken __attribute__((swift_name("authToken")));
@property (readonly) DOSCMeetingConfig *config __attribute__((swift_name("config")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MeetingInfo.Companion")))
@interface DOSCMeetingInfoCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCMeetingInfoCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *BASE_URL_PROD __attribute__((swift_name("BASE_URL_PROD")));
@property (readonly) NSString *BASE_URL_TEST __attribute__((swift_name("BASE_URL_TEST")));
@end;
