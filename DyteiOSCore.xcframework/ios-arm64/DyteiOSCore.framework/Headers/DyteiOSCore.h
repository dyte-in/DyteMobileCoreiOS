...
@class DOSCDyteMeetingInfo, DOSCDyteMeetingInfoV2, DOSCDyteChat, DOSCDyteLiveStream, DOSCDyteSelfParticipant, DOSCDyteMeta, DOSCDyteRoomParticipants, DOSCDytePlugins, DOSCDytePoll, DOSCDyteRecording, DOSCDyteWebinar, DOSCDyteMobileClient, DOSCKotlinEnumCompanion, DOSCKotlinEnum<E>, DOSCAudioDeviceTypeDefault, DOSCAudioDeviceType, DOSCKotlinArray<T>, DOSCDyteAudioDeviceDefault, DOSCDyteAudioDevice, DOSCParticipantFlags, DOSCWebrtcVideoStreamTrack, DOSCDyteMeetingParticipant, DOSCDyteJoinedMeetingParticipantCompanion, UIView, DOSCDyteJoinedMeetingParticipant, DOSCDyteMediaPermission, DOSCDyteMeetingInfoDefault, DOSCDyteMeetingInfoV2Default, DOSCDyteMeetingTypeCompanion, DOSCDyteMeetingType, DOSCKotlinx_serialization_jsonJsonElement, DOSCDyteWaitlistedParticipant, DOSCDyteScreenShareMeetingParticipant, DOSCDyteScreenShareMeetingParticipantCompanion, DOSCDyteVideoDevice, DOSCDyteDesignToken, DOSCSelfPermissions, DOSCWaitListStatus, DOSCDyteVideoDeviceDefault, DOSCVideoDeviceType, DOSCPeerPriorityObject, DOSCVideoDeviceTypeDefault, DOSCDyteEventType, DOSCDyteEventTypeOnAudioDevicesChanged, DOSCDyteEventTypeOnCameraClosed, DOSCDyteEventTypeOnCameraDisconnected, DOSCDyteEventTypeOnConnectedToMeetingRoom, DOSCDyteEventTypeOnConnectingToMeetingRoom, DOSCDyteEventTypeOnDisconnectedFromMeetingRoom, DOSCDyteEventTypeOnFirstFrameAvailable, DOSCDyteEventTypeOnHostKicked, DOSCDyteEventTypeOnLiveStreamEnded, DOSCDyteEventTypeOnLiveStreamEnding, DOSCDyteEventTypeOnLiveStreamErrored, DOSCLiveStreamStageRequestPeer, DOSCDyteEventTypeOnLiveStreamStarted, DOSCDyteEventTypeOnLiveStreamStarting, DOSCDyteEventTypeOnLivestreamUpdate, DOSCDyteChatMessage, DOSCDytePollMessage, DOSCKotlinException, DOSCDyteEventTypeOnMeetingRecordingStarted, DOSCDyteRecordingState, DOSCDyteEventTypeOnMeetingRecordingStopped, DOSCDyteEventTypeOnMeetingRoomConnectionFailed, DOSCDyteEventTypeOnMeetingRoomDisconnected, DOSCDyteEventTypeOnMeetingRoomInitCompleted, DOSCDyteEventTypeOnMeetingRoomInitStarted, DOSCDyteEventTypeOnMeetingRoomJoinStarted, DOSCDyteEventTypeOnMeetingRoomJoinedWithoutCameraPermission, DOSCDyteEventTypeOnMeetingRoomJoinedWithoutMicPermission, DOSCDyteEventTypeOnMeetingRoomLeave, DOSCDyteEventTypeOnMeetingRoomLeaveStarted, DOSCDyteEventTypeOnMeetingRoomReconnectionFailed, DOSCDyteEventTypeOnMetaUpdate, DOSCDyteEventTypeOnNoActiveSpeaker, DOSCDytePlugin, DOSCDyteEventTypeOnReconnectedToMeetingRoom, DOSCDyteEventTypeOnReconnectingToMeetingRoom, DOSCDyteEventTypeOnSelfAudioUpdate, DOSCStageStatus, DOSCDyteEventTypeOnSelfUpdate, DOSCDyteEventTypeOnSelfVideoUpdate, DOSCDyteEventTypeOnWebinarPresentRequest, DOSCRequestToPresentParticipant, DOSCDyteEventTypeOnWebinarStartedPresenting, DOSCDyteEventTypeOnWebinarStoppedPresenting, DOSCLiveStreamState, DOSCDyteLivestreamDataCompanion, DOSCDyteLivestreamData, DOSCDyteRecordingStateCompanion, DOSCGridInfo, DOSCWebSocketChatMessagesModel, DOSCWebSocketChatMessage, NSURL, DOSCLiveStreamStagePeer, DOSCMeetingConfig, DOSCParticipantInfo, DOSCWebSocketJoinRoomModel, DOSCWebSocketRoomStateModel, DOSCWebSocketPeerMuteModel, DOSCWebSocketMeetingPeerUser, DOSCWebSocketPeerLeftModel, DOSCWebSocketPeerPinnedModel, DOSCWebSocketConsumerClosedModel, DOSCWebSocketConsumerResumedModel, DOSCWebSocketSelectedPeersModel, DOSCPeerWithPriority, DOSCPermissionType, DOSCPermission, DOSCWebSocketPluginDisabled, DOSCWebSocketPluginEnabled, DOSCWebSocketPluginEvent, DOSCWebSocketPoll, DOSCDytePollOption, DOSCProto_entitiesProducerState, DOSCDyte_media_clientHiveTransport, DOSCInboundMeetingEventType, DOSCOutboundMeetingEventType, DOSCWebSocketWaitlistPeerAccepted, DOSCWebSocketWaitlistPeerAdded, DOSCWebSocketWaitlistPeerClosed, DOSCWebSocketWaitlistPeerRejected, DOSCLiveStreamStagePeerCompanion, DOSCLiveStreamStageRequestPeerCompanion, DOSCLiveStreamStateCompanion, DOSCPeerProducerMeta, DOSCRequestToPresentParticipantCompanion, DOSCSocketConnectionEvent, DOSCInboundMeetingEvent, DOSCStageStatusCompanion, DOSCDyteMessageType, DOSCDytePluginCompanion, WKWebView, DOSCKotlinNothing, DOSCDytePollCompanion, DOSCDytePollVote, DOSCDytePollOptionCompanion, DOSCDytePollVoteCompanion, DOSCDyteWaitlistedParticipantCompanion, NSOperationQueue, NSNotification, DOSCWebrtcAudioStreamTrack, DOSCWebrtcMediaStream, DOSCWebRtcCreateTransportModel, DOSCIceServerData, DOSCDyte_media_clientHiveConsumer, DOSCKotlinPair<__covariant A, __covariant B>, DOSCDyte_media_clientHiveConsumerOptions, DOSCWebrtcMediaStreamTrack, DOSCProducerType, DOSCDyte_media_clientHiveProducerOptions, DOSCDyte_media_clientHiveProducer, DOSCLogStatus, DOSCLogSeverity, DOSCDyteLogCompanion, DOSCDyteLog, DOSCDyteTrace, DOSCMeetingMetaDataCompanion, DOSCMeetingMetaData, DOSCPostDyteLogsCompanion, DOSCPostDyteLogs, DOSCSocketOptions, DOSCSocketEvent<T>, DOSCSocket, DOSCKotlinUnit, DOSCSocketConnectionEventConnected, DOSCSocketConnectionEventConnecting, DOSCSocketConnectionEventConnectionFailed, DOSCSocketConnectionEventDisconnected, DOSCSocketConnectionEventReconnected, DOSCSocketConnectionEventReconnecting, DOSCSocketConnectionEventReconnectionAttempt, DOSCSocketConnectionEventReconnectionAttemptFailed, DOSCSocketConnectionEventReconnectionFailed, DOSCSocketEventCompanion, DOSCSocketEventConnect, DOSCSocketEventConnecting, DOSCSocketEventDisconnect, DOSCSocketEventError, DOSCSocketEventMessage, DOSCSocketEventPing, DOSCSocketEventPong, DOSCSocketEventReconnect, DOSCSocketEventReconnectAttempt, DOSCSocketOptionsTransport, DOSCKotlinThrowable, DOSCKotlinRuntimeException, DOSCKotlinByteArray, DOSCSocketServiceConnectionStateCompanion, DOSCSocketServiceConnectionState, DOSCSocketServiceConnectionStateAttemptingReconnect, DOSCSockrates_clientWebSocketConnectionState, DOSCSocketServiceConnectionStateConnected, DOSCSocketServiceConnectionStateDisconnected, DOSCSocketServiceConnectionStateReconnectAttemptFailed, DOSCSocketServiceConnectionStateReconnectFailed, DOSCSocketServiceConnectionStateReconnected, DOSCSocketServiceConnectionStateReconnecting, DOSCBasePayloadModel, DOSCOutboundMeetingEvents, DOSCResponseModelCompanion, DOSCResponseModel, DOSCConsumerAppDataCompanion, DOSCConsumerAppData, DOSCCodec, DOSCHeaderExtension, DOSCEncodings, DOSCRtcp, DOSCConsumerRtpParametersCompanion, DOSCConsumerRtpParameters, DOSCDeviceCompanion, DOSCDevice, DOSCRtx, DOSCEncodingsCompanion, DOSCMeetingPeerFlagsCompanion, DOSCMeetingPeerFlags, DOSCMeetingPeerMetadataCompanion, DOSCMeetingPeerMetadata, DOSCRtcpCompanion, DOSCRtxCompanion, DOSCWebSocketActiveSpeakerModelCompanion, DOSCWebSocketActiveSpeakerModel, DOSCWebSocketChatMessageCompanion, DOSCWebSocketChatMessagesModelCompanion, DOSCWebSocketConnectTransportModelCompanion, DOSCWebSocketConnectTransportModel, DOSCWebSocketConsumerClosedModelCompanion, DOSCWebSocketConsumerModelCompanion, DOSCWebSocketConsumerModel, DOSCWebSocketConsumerResumedModelCompanion, DOSCWebSocketEmptyModelCompanion, DOSCWebSocketEmptyModel, DOSCWebSocketGetPageModelCompanion, DOSCWebSocketGetPageModel, DOSCWebSocketMeetingPeerUserCompanion, DOSCWebSocketPeerLeftModelCompanion, DOSCWebSocketPeerMuteModelCompanion, DOSCWebSocketPeerPinnedModelCompanion, DOSCWebSocketPluginDisabledCompanion, DOSCWebSocketPluginEnabledCompanion, DOSCWebSocketPollOption, DOSCWebSocketPollCompanion, DOSCWebSocketPollModelCompanion, DOSCWebSocketPollModel, DOSCWebSocketPollVote, DOSCWebSocketPollOptionCompanion, DOSCWebSocketPollVoteCompanion, DOSCWebSocketPollsModelCompanion, DOSCWebSocketPollsModel, DOSCWebSocketProducerClosedModelCompanion, DOSCWebSocketProducerClosedModel, DOSCWebSocketProducerConnectModelCompanion, DOSCWebSocketProducerConnectModel, DOSCWebSocketRoomMessageCompanion, DOSCWebSocketRoomMessage, DOSCWebSocketSelectedPeersModelCompanion, DOSCWebSocketWaitlistPeerAcceptedCompanion, DOSCWebSocketWaitlistPeerAddedCompanion, DOSCWebSocketWaitlistPeerClosedCompanion, DOSCWebSocketWaitlistPeerRejectedCompanion, DOSCWebSocketWebinarPeerCompanion, DOSCWebSocketWebinarPeer, DOSCWebSocketWebinarPeerAddedToStageCompanion, DOSCWebSocketWebinarPeerAddedToStage, DOSCWebSocketWebinarPeerRemovedFromStageCompanion, DOSCWebSocketWebinarPeerRemovedFromStage, DOSCWebSocketWebinarPresentRequestAcceptedCompanion, DOSCWebSocketWebinarPresentRequestAccepted, DOSCWebSocketWebinarRemovedFromStageCompanion, DOSCWebSocketWebinarRemovedFromStage, DOSCWebSocketWebinarRequestToJoinPeerAddedCompanion, DOSCWebSocketWebinarRequestToJoinPeerAdded, DOSCWebSocketWebinarStagePeerCompanion, DOSCWebSocketWebinarStagePeer, DOSCCodecRtcpFeedback, DOSCCodecParameters, DOSCCodecCompanion, DOSCCodecParametersCompanion, DOSCCodecRtcpFeedbackCompanion, DOSCCreateWebRTCTransportPayloadRequestModelCompanion, DOSCCreateWebRTCTransportPayloadRequestModel, DOSCFingerprint, DOSCDtlsParametersCompanion, DOSCDtlsParameters, DOSCFingerprintCompanion, DOSCHeaderExtensionCompanion, DOSCIceCandidateCompanion, DOSCIceCandidate, DOSCIceParametersCompanion, DOSCIceParameters, DOSCRouterCapabilitiesModel, DOSCJoinRoomPayloadRequestModelCompanion, DOSCJoinRoomPayloadRequestModel, DOSCRoomStateConfig, DOSCRoomStatePlugin, DOSCRoomStateCompanion, DOSCRoomState, DOSCRoomStateAccessCompanion, DOSCRoomStateAccess, DOSCRoomStateConfigCompanion, DOSCRoomStatePluginCompanion, DOSCRouterCapabilitiesModelCompanion, DOSCWebRtcCreateTransportModelCompanion, DOSCWebSocketJoinRoomModelCompanion, DOSCWebSocketRoomStateModelCompanion, DOSCPluginAuthResponse, DOSCRecordingInfo, DOSCKtor_client_coreHttpClient, DOSCIceServersWrapper, DOSCIpDetailsResponsePayload, DOSCPluginConfigResponse, DOSCPluginResponse, DOSCMultiplePluginResponse, DOSCMeetingSessionInfo, DOSCUserPresetDataWrapper, DOSCLiveStreamData, DOSCActiveLiveStreamResponseCompanion, DOSCActiveLiveStreamResponse, DOSCBorderRadiusTypeCompanion, DOSCBorderRadiusType, DOSCBorderWidthTypeCompanion, DOSCBorderWidthType, DOSCChatPrivatePermissionsCompanion, DOSCChatPrivatePermissions, DOSCChatPublicPermissionsCompanion, DOSCChatPublicPermissions, DOSCCreateMeetingRequestCompanion, DOSCCreateMeetingRequest, DOSCCreateMeetingResponseCompanion, DOSCCreateMeetingResponse, DOSCCreateMeetingResponseWrapperCompanion, DOSCCreateMeetingResponseWrapper, DOSCCreateParticipantRequestCompanion, DOSCCreateParticipantRequest, DOSCCreateParticipantResponseCompanion, DOSCCreateParticipantResponse, DOSCCreateParticipantResponseWrapperCompanion, DOSCCreateParticipantResponseWrapper, DOSCFeaturesOrganizationModelWrapper, DOSCFeaturesDataCompanion, DOSCFeaturesData, DOSCFeaturesOrganizationModelCompanion, DOSCFeaturesOrganizationModel, DOSCFeaturesOrganizationModelWrapperCompanion, DOSCGraphQlRequestVariables, DOSCGraphQlRequestCompanion, DOSCGraphQlRequest, DOSCGraphQlRequestVariablesCompanion, DOSCIceServerDataCompanion, DOSCIceServersWrapperCompanion, DOSCIpDetailsResponsePayloadCompanion, DOSCLiveStreamDataCompanion, DOSCVideoConfig, DOSCMediaConfigCompanion, DOSCMediaConfig, DOSCMediaPresetCompanion, DOSCMediaPreset, DOSCMeetingSessionDataCompanion, DOSCMeetingSessionData, DOSCMeetingSessionDataWrapperV1, DOSCMeetingSessionDataResponseV1Companion, DOSCMeetingSessionDataResponseV1, DOSCMeetingSessionDataWrapperCompanion, DOSCMeetingSessionDataWrapper, DOSCMeetingSessionDataWrapperV1Companion, DOSCMultiplePluginResponsePlugins, DOSCMultiplePluginResponseCompanion, DOSCPluginDataResponse, DOSCMultiplePluginResponsePluginsCompanion, DOSCPublicChatPreset, DOSCPrivateChatPreset, DOSCParticipantChatPresetCompanion, DOSCParticipantChatPreset, DOSCParticipantDataCompanion, DOSCParticipantData, DOSCParticipantPreset, DOSCParticipantDataWrapperCompanion, DOSCParticipantDataWrapper, DOSCParticipantMediaPresetCompanion, DOSCParticipantMediaPreset, DOSCParticipantPluginPresetCompanion, DOSCParticipantPluginPreset, DOSCParticipantPollPresetCompanion, DOSCParticipantPollPreset, DOSCParticipantPresetPermission, DOSCUserPresetUI, DOSCParticipantPresetConfig, DOSCParticipantPresetCompanion, DOSCVideoStreamConfig, DOSCParticipantPresetConfigCompanion, DOSCParticipantPresetPermissionCompanion, DOSCPluginAuthDataResponseCompanion, DOSCPluginAuthDataResponse, DOSCPluginAuthResponseCompanion, DOSCPluginAuthorizationModelCompanion, DOSCPluginAuthorizationModel, DOSCPluginFiles, DOSCPluginView, DOSCPluginConfigResponseCompanion, DOSCPluginDataResponseCompanion, DOSCPluginFilesCompanion, DOSCPluginResponseCompanion, DOSCPluginViewCompanion, DOSCPresignedUrlDataCompanion, DOSCPresignedUrlData, DOSCPresignedUrlRequestCompanion, DOSCPresignedUrlRequest, DOSCPresignedUrlResponseCompanion, DOSCPresignedUrlResponse, DOSCPrivateChatPresetCompanion, DOSCPublicChatPresetCompanion, DOSCRecordingDataCompanion, DOSCRecordingData, DOSCRecordingDataWrapperCompanion, DOSCRecordingDataWrapper, DOSCRecordingResponseWrapperCompanion, DOSCRecordingResponseWrapper, DOSCRecordingResponseWrapperV2Companion, DOSCRecordingResponseWrapperV2, DOSCStartLiveStreamResponseCompanion, DOSCStartLiveStreamResponse, DOSCStartRecordingModelCompanion, DOSCStartRecordingModel, DOSCStopLiveStreamDataCompanion, DOSCStopLiveStreamData, DOSCStopLiveStreamResponseCompanion, DOSCStopLiveStreamResponse, DOSCStopRecordingModelCompanion, DOSCStopRecordingModel, DOSCStopRecordingModelV2Companion, DOSCStopRecordingModelV2, DOSCUserDataWrapperCompanion, DOSCUserDataWrapper, DOSCUserDataWrapperV1Companion, DOSCUserDataWrapperV1, DOSCUserPresetAloneHereThemeCompanion, DOSCUserPresetAloneHereTheme, DOSCUserPresetChatPermissionPropsCompanion, DOSCUserPresetChatPermissionProps, DOSCUserPresetColorsThemeCompanion, DOSCUserPresetColorsTheme, DOSCUserPresetControlBarThemeElements, DOSCUserPresetControlBarThemeCompanion, DOSCUserPresetControlBarTheme, DOSCUserPresetControlBarThemeElementsCompanion, DOSCUserPresetModel, DOSCUserPresetDataCompanion, DOSCUserPresetData, DOSCUserPresetDataWrapperCompanion, DOSCUserPresetDesignColorsCompanion, DOSCUserPresetDesignColors, DOSCUserPresetDesignTokenCompanion, DOSCUserPresetDesignToken, DOSCUserPresetMultiTheme, DOSCUserPresetSingleTheme, DOSCUserPresetGridThemeCompanion, DOSCUserPresetGridTheme, DOSCUserPresetHeaderThemeElements, DOSCUserPresetHeaderThemeCompanion, DOSCUserPresetHeaderTheme, DOSCUserPresetHeaderThemeElementsCompanion, DOSCUserPresetPermissionsModel, DOSCUserPresetThemeModel, DOSCUserPresetModelCompanion, DOSCUserPresetMultiThemeCompanion, DOSCWaitingRoomType, DOSCUserPresetPluginPermissions, DOSCUserPresetPollsPermissions, DOSCUserPresetProducePermissions, DOSCUserPresetPermissionsModelCompanion, DOSCUserPresetPluginConfigCompanion, DOSCUserPresetPluginConfig, DOSCUserPresetPluginPermissionsCompanion, DOSCUserPresetPollsPermissionsCompanion, DOSCUserPresetVideoPermissions, DOSCUserPresetScreenSharePermissions, DOSCUserPresetProducePermissionsCompanion, DOSCUserPresetRequestModelCompanion, DOSCUserPresetRequestModel, DOSCUserPresetScreenSharePermissionsCompanion, DOSCUserPresetSetupScreenThemeCompanion, DOSCUserPresetSetupScreenTheme, DOSCUserPresetSingleThemeCompanion, DOSCUserPresetThemeModelCompanion, DOSCUserPresetUICompanion, DOSCUserPresetVideoPermissionsCompanion, DOSCUserPresetWaitingRoomThemeCompanion, DOSCUserPresetWaitingRoomTheme, DOSCVideoConfigCompanion, DOSCVideoStreamConfigCompanion, DOSCWaitingRoomTypeCompanion, DOSCChatPermissionsCompanion, DOSCChatPermissions, DOSCDyteDesignTokenCompanion, DOSCGridInfo_, DOSCHostPermissionsCompanion, DOSCHostPermissions, DOSCLiveStreamPermissionsCompanion, DOSCLiveStreamPermissions, DOSCMediaPermissionsCompanion, DOSCMediaPermissions, DOSCVideoPermissions, DOSCMiscellaneousPermissions, DOSCParticipantInfoCompanion, DOSCPresetInfo, DOSCPluginPermissionsCompanion, DOSCPluginPermissions, DOSCPollPermissionsCompanion, DOSCPollPermissions, DOSCPresetInfoCompanion, DOSCSelfPermissionsCompanion, DOSCWaitingRoomPermissions, DOSCVideoPermissionsCompanion, DOSCWaitingRoomPermissionsCompanion, DOSCPlatformFile, DOSCDyteIOSPlatformCompanion, DOSCKotlinByteIterator, NSData, DOSCWebrtcMediaStreamTrackCompanion, RTCMediaStreamTrack, DOSCWebrtcMediaStreamTrackKind, DOSCKotlinx_serialization_jsonJsonElementCompanion, DOSCKotlinIllegalStateException, DOSCWire_runtimeProtoAdapter<E>, DOSCOkioByteString, DOSCWire_runtimeMessage<M, B>, DOSCProto_entitiesProducerKind, DOSCProto_entitiesProducerStateCompanion, DOSCDyte_media_clientHiveInternalTransportOptions, DOSCDyte_media_clientHiveConnectionState, DOSCWebrtcDataChannel, DOSCWebrtcRtpTransceiverDirection, DOSCDyte_media_clientHiveUnifiedPlan, DOSCWebrtcRtcStatsReport, DOSCDyte_media_clientHiveGenericHandlerResult, DOSCDyte_media_clientHiveConsumerCreationTaskException, DOSCWebrtcSessionDescription, DOSCWebrtcIceServer, DOSCKotlinx_coroutines_coreCoroutineDispatcher, RTCMediaStream, DOSCDyte_media_clientHiveInternalConsumerOptions, DOSCWebrtcCommonRtpEncodingParameters, DOSCDyte_media_clientHiveCodecOptions, DOSCDyte_media_clientHiveInternalProducerOptions, DOSCKtor_client_coreHttpClientEngineConfig, DOSCKtor_client_coreHttpClientConfig<T>, DOSCKtor_eventsEvents, DOSCKtor_client_coreHttpReceivePipeline, DOSCKtor_client_coreHttpRequestPipeline, DOSCKtor_client_coreHttpResponsePipeline, DOSCKtor_client_coreHttpSendPipeline, DOSCWire_runtimeFieldEncoding, DOSCWire_runtimeSyntax, DOSCWire_runtimeProtoAdapterCompanion, DOSCWire_runtimeProtoReader, DOSCWire_runtimeProtoWriter, DOSCWire_runtimeReverseProtoWriter, DOSCOkioByteStringCompanion, DOSCOkioBuffer, DOSCOkioTimeout, DOSCProto_entitiesProducerKindCompanion, DOSCWebrtcIceTransportPolicy, DOSCDyte_media_clientHiveTransportOptions, DOSCDyte_media_clientHiveHandlerInterface, DOSCKotlinCancellationException, RTCDataChannel, DOSCWebrtcDataChannelState, NSObject, DOSCDyte_media_clientHiveHandlerRunOptions, DOSCDyte_media_clientHiveHandlerSendOptions, DOSCDyte_media_clientHiveHandlerSendResult, DOSCWebrtcRtpTransceiver, DOSCDyte_media_clientHiveUnifiedPlanCompanion, RTCLegacyStatsReport, DOSCWebrtcRtcStats, DOSCDyte_media_clientHiveConsumerCreationTaskOptions, DOSCWebrtcSessionDescriptionType, DOSCWebrtcTlsCertPolicy, RTCIceServer, DOSCKotlinAbstractCoroutineContextElement, DOSCKotlinx_coroutines_coreCoroutineDispatcherKey, DOSCKotlinx_serialization_coreSerializersModule, DOSCKotlinx_serialization_coreSerialKind, DOSCKtor_client_coreHttpRequestData, DOSCKtor_client_coreHttpResponseData, DOSCKtor_client_coreProxyConfig, DOSCKtor_utilsAttributeKey<T>, DOSCKtor_eventsEventDefinition<T>, DOSCKtor_utilsPipelinePhase, DOSCKtor_utilsPipeline<TSubject, TContext>, DOSCKtor_client_coreHttpReceivePipelinePhases, DOSCKtor_client_coreHttpResponse, DOSCKtor_client_coreHttpRequestPipelinePhases, DOSCKtor_client_coreHttpRequestBuilder, DOSCKtor_client_coreHttpResponsePipelinePhases, DOSCKtor_client_coreHttpResponseContainer, DOSCKtor_client_coreHttpClientCall, DOSCKtor_client_coreHttpSendPipelinePhases, DOSCWire_runtimeFieldEncodingCompanion, DOSCWire_runtimeSyntaxCompanion, DOSCKotlinDoubleArray, DOSCWire_runtimeDuration, DOSCKotlinIntArray, DOSCKotlinLongArray, DOSCKotlinFloatArray, DOSCWire_runtimeInstant, DOSCWire_runtimeProtoReaderCompanion, DOSCWire_runtimeProtoWriterCompanion, DOSCOkioBufferUnsafeCursor, DOSCOkioTimeoutCompanion, DOSCWebrtcRtpCodecParameters, RTCRtpTransceiver, DOSCWebrtcRtpReceiver, DOSCWebrtcRtpSender, DOSCDyte_media_clientHiveConsumerStateObject, DOSCKotlinAbstractCoroutineContextKey<B, E>, DOSCKtor_httpUrl, DOSCKtor_httpHttpMethod, DOSCKtor_httpOutgoingContent, DOSCKtor_httpHttpStatusCode, DOSCKtor_utilsGMTDate, DOSCKtor_httpHttpProtocolVersion, DOSCKtor_httpHeadersBuilder, DOSCKtor_client_coreHttpRequestBuilderCompanion, DOSCKtor_httpURLBuilder, DOSCKtor_utilsTypeInfo, DOSCKtor_client_coreHttpClientCallCompanion, DOSCKotlinDoubleIterator, DOSCKotlinIntIterator, DOSCKotlinLongIterator, DOSCKotlinFloatIterator, DOSCKotlinx_coroutines_coreAtomicDesc, DOSCKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, RTCRtpCodecParameters, RTCRtpReceiver, DOSCWebrtcRtpParameters, RTCRtpSender, DOSCWebrtcDtmfSender, DOSCKtor_httpUrlCompanion, DOSCKtor_httpURLProtocol, DOSCKtor_httpHttpMethodCompanion, DOSCKtor_httpContentType, DOSCKtor_httpHttpStatusCodeCompanion, DOSCKtor_utilsGMTDateCompanion, DOSCKtor_utilsWeekDay, DOSCKtor_utilsMonth, DOSCKtor_httpHttpProtocolVersionCompanion, DOSCKtor_ioMemory, DOSCKtor_ioChunkBuffer, DOSCKtor_ioBuffer, DOSCKtor_ioByteReadPacket, DOSCKtor_utilsStringValuesBuilderImpl, DOSCKtor_httpURLBuilderCompanion, DOSCKotlinx_coroutines_coreAtomicOp<__contravariant T>, DOSCKotlinx_coroutines_coreOpDescriptor, DOSCKotlinx_coroutines_coreLockFreeLinkedListNode, DOSCKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, RTCRtpParameters, DOSCWebrtcRtpEncodingParameters, DOSCWebrtcHeaderExtension, DOSCWebrtcRtcpParameters, DOSCKtor_httpURLProtocolCompanion, DOSCKtor_httpHeaderValueParam, DOSCKtor_httpHeaderValueWithParametersCompanion, DOSCKtor_httpHeaderValueWithParameters, DOSCKtor_httpContentTypeCompanion, DOSCKtor_utilsWeekDayCompanion, DOSCKtor_utilsMonthCompanion, DOSCKtor_ioMemoryCompanion, DOSCKtor_ioBufferCompanion, DOSCKtor_ioChunkBufferCompanion, DOSCKtor_ioInputCompanion, DOSCKtor_ioInput, DOSCKtor_ioByteReadPacketCompanion, DOSCKotlinKTypeProjection, DOSCKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, DOSCKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>, RTCRtpEncodingParameters, RTCRtpHeaderExtension, RTCRtcpParameters, DOSCKotlinKVariance, DOSCKotlinKTypeProjectionCompanion;

@protocol DOSCDyteCameraEventsListener, DOSCDyteChatEventsListener, DOSCDyteDataUpdateListener, DOSCDyteLiveStreamEventsListener, DOSCDyteMeetingRoomEventsListener, DOSCDyteMicrophoneEventsListener, DOSCDyteParticipantEventsListener, DOSCDytePluginEventsListener, DOSCDytePollEventsListener, DOSCDyteRecordingEventsListener, DOSCDyteSelfEventsListener, DOSCDyteWaitlistEventsListener, DOSCDyteWebinarEventsListener, DOSCKotlinx_coroutines_coreCoroutineScope, DOSCKotlinComparable, DOSCDyteParticipantUpdateListener, DOSCDytePermissionEventsListener, DOSCSocketConnectionEventListener, DOSCSocketMessageEventListener, DOSCKotlinx_serialization_coreKSerializer, DOSCILoggerController, DOSCIDyteCommonMediaUtils, DOSCKotlinx_coroutines_coreMutableSharedFlow, DOSCIDyteSFUUtils, DOSCIDyteHive, DOSCDyte_media_clientIMediaClientLogger, DOSCSocketBuilder, DOSCMapper, DOSCISocketMessageResponseParser, DOSCSocketServiceConnectionStateListener, DOSCSocketServiceEventListener, DOSCIDyteLoggerUtils, DOSCIDytePlatformUtils, DOSCIDytePlatformPermissionUtils, DOSCIDyteVideoUtils, DOSCIDyteWebViewListener, DOSCIDyteWebView, DOSCKotlinCoroutineContext, DOSCKotlinIterator, DOSCKotlinx_coroutines_coreStateFlow, RTCVideoRenderer, DOSCOkioBufferedSink, DOSCKotlinx_coroutines_coreCompletableDeferred, DOSCKotlinx_serialization_coreEncoder, DOSCKotlinx_serialization_coreSerialDescriptor, DOSCKotlinx_serialization_coreSerializationStrategy, DOSCKotlinx_serialization_coreDecoder, DOSCKotlinx_serialization_coreDeserializationStrategy, DOSCKotlinx_coroutines_coreFlowCollector, DOSCKotlinx_coroutines_coreFlow, DOSCKotlinx_coroutines_coreSharedFlow, DOSCKtor_ioCloseable, DOSCKtor_client_coreHttpClientEngine, DOSCKtor_client_coreHttpClientEngineCapability, DOSCKtor_utilsAttributes, DOSCKotlinCoroutineContextElement, DOSCKotlinCoroutineContextKey, DOSCKotlinKClass, DOSCOkioBufferedSource, DOSCOkioSource, DOSCOkioCloseable, DOSCOkioSink, DOSCWire_runtimeWireEnum, DOSCKotlinx_coroutines_coreSelectClause1, DOSCKotlinx_coroutines_coreChildHandle, DOSCKotlinx_coroutines_coreChildJob, DOSCKotlinx_coroutines_coreDisposableHandle, DOSCKotlinx_coroutines_coreJob, DOSCKotlinSequence, DOSCKotlinx_coroutines_coreSelectClause0, DOSCKotlinx_coroutines_coreDeferred, DOSCKotlinSuspendFunction1, DOSCKotlinContinuation, DOSCKotlinContinuationInterceptor, DOSCKotlinx_coroutines_coreRunnable, DOSCKotlinx_serialization_coreCompositeEncoder, DOSCKotlinAnnotation, DOSCKotlinx_serialization_coreCompositeDecoder, DOSCKtor_client_coreHttpClientPlugin, DOSCKotlinSuspendFunction2, DOSCKotlinKDeclarationContainer, DOSCKotlinKAnnotatedElement, DOSCKotlinKClassifier, DOSCKotlinx_coroutines_coreSelectInstance, DOSCKotlinx_coroutines_coreParentJob, DOSCKotlinSuspendFunction0, DOSCKotlinFunction, DOSCKotlinx_serialization_coreSerializersModuleCollector, DOSCKtor_httpHeaders, DOSCKtor_httpHttpMessage, DOSCKtor_ioByteReadChannel, DOSCKtor_httpHttpMessageBuilder, DOSCKtor_client_coreHttpRequest, DOSCKtor_httpParameters, DOSCKotlinMapEntry, DOSCKtor_utilsStringValues, DOSCKtor_ioReadSession, DOSCKotlinAppendable, DOSCKtor_utilsStringValuesBuilder, DOSCKtor_httpParametersBuilder, DOSCKotlinKType, RTCDtmfSender, DOSCKtor_ioObjectPool;
...
- (void)addMicrophoneEventsListenerMicrophoneEventsListener:(id<DOSCDyteMicrophoneEventsListener>)microphoneEventsListener __attribute__((swift_name("addMicrophoneEventsListener(microphoneEventsListener:)")));
...
- (void)addWebinarEventsListenerWebinarEventsListener:(id<DOSCDyteWebinarEventsListener>)webinarEventsListener __attribute__((swift_name("addWebinarEventsListener(webinarEventsListener:)")));
...
- (void)removeMicrophoneEventsListenerMicrophoneEventsListener:(id<DOSCDyteMicrophoneEventsListener>)microphoneEventsListener __attribute__((swift_name("removeMicrophoneEventsListener(microphoneEventsListener:)")));
...
- (void)removeWebinarEventsListenerWebinarEventsListener:(id<DOSCDyteWebinarEventsListener>)webinarEventsListener __attribute__((swift_name("removeWebinarEventsListener(webinarEventsListener:)")));
...
@property (readonly) DOSCWebrtcVideoStreamTrack * _Nullable videoTrack __attribute__((swift_name("videoTrack")));
@end
...
@property (class, readonly, getter=companion) DOSCDyteJoinedMeetingParticipantCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteJoinedMeetingParticipant.Companion")))
@interface DOSCDyteJoinedMeetingParticipantCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteJoinedMeetingParticipantCompanion *shared __attribute__((swift_name("shared")));
- (DOSCDyteJoinedMeetingParticipant *)getParticipant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("get(participant:)")));
@end
...
- (void)broadcastMessagePayload:(NSDictionary<NSString *, DOSCKotlinx_serialization_jsonJsonElement *> *)payload __attribute__((swift_name("broadcastMessage(payload:)")));
- (DOSCDyteRoomParticipants *)doCopyWaitlisted:(NSArray<DOSCDyteWaitlistedParticipant *> *)waitlisted joined:(NSArray<DOSCDyteJoinedMeetingParticipant *> *)joined _active:(NSArray<DOSCDyteJoinedMeetingParticipant *> *)_active screenshares:(NSArray<DOSCDyteScreenShareMeetingParticipant *> *)screenshares controllerContainer:(id)controllerContainer __attribute__((swift_name("doCopy(waitlisted:joined:_active:screenshares:controllerContainer:)")));
...
@property (readonly) NSArray<DOSCDyteScreenShareMeetingParticipant *> *screenshares __attribute__((swift_name("screenshares")));
@property (readonly) id<DOSCKotlinx_coroutines_coreCoroutineScope> serialScope __attribute__((swift_name("serialScope")));
...
@property (readonly) NSString * _Nullable picture __attribute__((swift_name("picture")));
@property (readonly) NSString *presetName __attribute__((swift_name("presetName")));
@property (readonly) DOSCWebrtcVideoStreamTrack * _Nullable screenShareTrack __attribute__((swift_name("screenShareTrack")));
@property (readonly) NSString *userId __attribute__((swift_name("userId")));
@end
...
- (DOSCDyteScreenShareMeetingParticipant *)getParticipant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("get(participant:)")));
@end
...
- (instancetype)initWithActiveParticipants:(NSArray<DOSCDyteJoinedMeetingParticipant *> *)activeParticipants __attribute__((swift_name("init(activeParticipants:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSArray<DOSCDyteJoinedMeetingParticipant *> *activeParticipants __attribute__((swift_name("activeParticipants")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnConnectedToMeetingRoom")))
@interface DOSCDyteEventTypeOnConnectedToMeetingRoom : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onConnectedToMeetingRoom __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnConnectedToMeetingRoom *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnConnectingToMeetingRoom")))
@interface DOSCDyteEventTypeOnConnectingToMeetingRoom : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onConnectingToMeetingRoom __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnConnectingToMeetingRoom *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnDisconnectedFromMeetingRoom")))
@interface DOSCDyteEventTypeOnDisconnectedFromMeetingRoom : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onDisconnectedFromMeetingRoom __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnDisconnectedFromMeetingRoom *shared __attribute__((swift_name("shared")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnLiveStreamStageRequestsUpdated")))
@interface DOSCDyteEventTypeOnLiveStreamStageRequestsUpdated : DOSCDyteEventType
- (instancetype)initWithRequests:(NSArray<DOSCLiveStreamStageRequestPeer *> *)requests __attribute__((swift_name("init(requests:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSArray<DOSCLiveStreamStageRequestPeer *> *requests __attribute__((swift_name("requests")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnLivestreamUpdate")))
@interface DOSCDyteEventTypeOnLivestreamUpdate : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onLivestreamUpdate __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnLivestreamUpdate *shared __attribute__((swift_name("shared")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnMeetingRoomConnectionFailed")))
@interface DOSCDyteEventTypeOnMeetingRoomConnectionFailed : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onMeetingRoomConnectionFailed __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnMeetingRoomConnectionFailed *shared __attribute__((swift_name("shared")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnMeetingRoomReconnectionFailed")))
@interface DOSCDyteEventTypeOnMeetingRoomReconnectionFailed : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onMeetingRoomReconnectionFailed __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnMeetingRoomReconnectionFailed *shared __attribute__((swift_name("shared")));
@end
...
- (instancetype)initWithParticipant:(DOSCDyteScreenShareMeetingParticipant *)participant __attribute__((swift_name("init(participant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCDyteScreenShareMeetingParticipant *participant __attribute__((swift_name("participant")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnReconnectedToMeetingRoom")))
@interface DOSCDyteEventTypeOnReconnectedToMeetingRoom : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onReconnectedToMeetingRoom __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnReconnectedToMeetingRoom *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnReconnectingToMeetingRoom")))
@interface DOSCDyteEventTypeOnReconnectingToMeetingRoom : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onReconnectingToMeetingRoom __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnReconnectingToMeetingRoom *shared __attribute__((swift_name("shared")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnSelfStageStatusUpdate")))
@interface DOSCDyteEventTypeOnSelfStageStatusUpdate : DOSCDyteEventType
- (instancetype)initWithStatus:(DOSCStageStatus *)status __attribute__((swift_name("init(status:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCStageStatus *status __attribute__((swift_name("status")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnStageCountUpdated")))
@interface DOSCDyteEventTypeOnStageCountUpdated : DOSCDyteEventType
...
- (instancetype)initWithParticipant:(DOSCDyteWaitlistedParticipant *)participant __attribute__((swift_name("init(participant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCDyteWaitlistedParticipant *participant __attribute__((swift_name("participant")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnWebinarPresentRequestAccepted")))
@interface DOSCDyteEventTypeOnWebinarPresentRequestAccepted : DOSCDyteEventType
- (instancetype)initWithPresentParticipant:(DOSCRequestToPresentParticipant *)presentParticipant __attribute__((swift_name("init(presentParticipant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCRequestToPresentParticipant *presentParticipant __attribute__((swift_name("presentParticipant")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnWebinarPresentRequestAdded")))
@interface DOSCDyteEventTypeOnWebinarPresentRequestAdded : DOSCDyteEventType
- (instancetype)initWithPresentParticipant:(DOSCRequestToPresentParticipant *)presentParticipant __attribute__((swift_name("init(presentParticipant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCRequestToPresentParticipant *presentParticipant __attribute__((swift_name("presentParticipant")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnWebinarPresentRequestClosed")))
@interface DOSCDyteEventTypeOnWebinarPresentRequestClosed : DOSCDyteEventType
- (instancetype)initWithPresentParticipant:(DOSCRequestToPresentParticipant *)presentParticipant __attribute__((swift_name("init(presentParticipant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCRequestToPresentParticipant *presentParticipant __attribute__((swift_name("presentParticipant")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnWebinarPresentRequestRejected")))
@interface DOSCDyteEventTypeOnWebinarPresentRequestRejected : DOSCDyteEventType
- (instancetype)initWithPresentParticipant:(DOSCRequestToPresentParticipant *)presentParticipant __attribute__((swift_name("init(presentParticipant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCRequestToPresentParticipant *presentParticipant __attribute__((swift_name("presentParticipant")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnWebinarPresentRequestWithdrawn")))
@interface DOSCDyteEventTypeOnWebinarPresentRequestWithdrawn : DOSCDyteEventType
- (instancetype)initWithPresentParticipant:(DOSCRequestToPresentParticipant *)presentParticipant __attribute__((swift_name("init(presentParticipant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCRequestToPresentParticipant *presentParticipant __attribute__((swift_name("presentParticipant")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnWebinarStartedPresenting")))
@interface DOSCDyteEventTypeOnWebinarStartedPresenting : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onWebinarStartedPresenting __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnWebinarStartedPresenting *shared __attribute__((swift_name("shared")));
@end
...
- (void)addWebinarEventListenerWebinarEventsListener:(id<DOSCDyteWebinarEventsListener>)webinarEventsListener __attribute__((swift_name("addWebinarEventListener(webinarEventsListener:)")));
...
- (void)removeWebinarEventListenerWebinarEventsListener:(id<DOSCDyteWebinarEventsListener>)webinarEventsListener __attribute__((swift_name("removeWebinarEventListener(webinarEventsListener:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)acceptAllRequestsWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("acceptAllRequests(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)acceptJoinStageWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("acceptJoinStage(completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getStagePeersWithCompletionHandler:(void (^)(NSArray<DOSCLiveStreamStagePeer *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getStagePeers(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getStageRequestsWithCompletionHandler:(void (^)(NSArray<DOSCLiveStreamStageRequestPeer *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getStageRequests(completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)rejectAllRequestsWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("rejectAllRequests(completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)rejectRequestToJoinWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("rejectRequestToJoin(completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)withdrawRequestToJoinWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("withdrawRequestToJoin(completionHandler:)")));
@property (readonly) DOSCDyteLivestreamData *livestreamData __attribute__((swift_name("livestreamData")));
@property (readonly) NSArray<DOSCLiveStreamStageRequestPeer *> *stageRequestPeers __attribute__((swift_name("stageRequestPeers")));
@end
...
- (NSString *)getBaseUrlWithoutVersion __attribute__((swift_name("getBaseUrlWithoutVersion()")));
...
- (int64_t)getMeetingStatedTime __attribute__((swift_name("getMeetingStatedTime()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)broadcastMessagePayload:(NSDictionary<NSString *, DOSCKotlinx_serialization_jsonJsonElement *> *)payload completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("broadcastMessage(payload:completionHandler:)")));
...
- (UIView *)getScreenShareViewDyteMeetingParticipant:(DOSCDyteScreenShareMeetingParticipant *)dyteMeetingParticipant __attribute__((swift_name("getScreenShareView(dyteMeetingParticipant:)")));
...
- (void)onParticipantVideoMutedParticipant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("onParticipantVideoMuted(participant:)")));
- (void)onParticipantVideoUnmutedParticipant:(DOSCDyteMeetingParticipant *)participant videoTrack:(DOSCWebrtcVideoStreamTrack *)videoTrack __attribute__((swift_name("onParticipantVideoUnmuted(participant:videoTrack:)")));
...
- (void)onPeerScreenShareStartedParticipant:(DOSCDyteScreenShareMeetingParticipant *)participant screenshareTrack:(DOSCWebrtcVideoStreamTrack *)screenshareTrack __attribute__((swift_name("onPeerScreenShareStarted(participant:screenshareTrack:)")));
- (void)onPeerScreenSharedEndedParticipant:(DOSCDyteScreenShareMeetingParticipant *)participant __attribute__((swift_name("onPeerScreenSharedEnded(participant:)")));
...
@property (readonly) DOSCDyteJoinedMeetingParticipant * _Nullable pinnedParticipant __attribute__((swift_name("pinnedParticipant")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pinPeerPeerId:(NSString * _Nullable)peerId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("pinPeer(peerId:completionHandler:)")));
...
@required
- (BOOL)canJoinStage __attribute__((swift_name("canJoinStage()")));
- (BOOL)shouldJoinStage __attribute__((swift_name("shouldJoinStage()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LiveStreamStagePeer")))
@interface DOSCLiveStreamStagePeer : DOSCBase
...
@property (class, readonly, getter=companion) DOSCLiveStreamStagePeerCompanion *companion __attribute__((swift_name("companion")));
- (DOSCLiveStreamStagePeer *)doCopyDisplayName:(NSString *)displayName userId:(NSString *)userId peerId:(NSString *)peerId __attribute__((swift_name("doCopy(displayName:userId:peerId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LiveStreamStagePeer.Companion")))
@interface DOSCLiveStreamStagePeerCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCLiveStreamStagePeerCompanion *shared __attribute__((swift_name("shared")));
- (DOSCLiveStreamStagePeer *)fromMapMap:(NSDictionary<NSString *, id> *)map __attribute__((swift_name("fromMap(map:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LiveStreamStageRequestPeer")))
@interface DOSCLiveStreamStageRequestPeer : DOSCBase
- (instancetype)initWithDisplayName:(NSString *)displayName userId:(NSString *)userId peerId:(NSString *)peerId __attribute__((swift_name("init(displayName:userId:peerId:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCLiveStreamStageRequestPeerCompanion *companion __attribute__((swift_name("companion")));
- (DOSCLiveStreamStageRequestPeer *)doCopyDisplayName:(NSString *)displayName userId:(NSString *)userId peerId:(NSString *)peerId __attribute__((swift_name("doCopy(displayName:userId:peerId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LiveStreamStageRequestPeer.Companion")))
@interface DOSCLiveStreamStageRequestPeerCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCLiveStreamStageRequestPeerCompanion *shared __attribute__((swift_name("shared")));
- (DOSCLiveStreamStageRequestPeer *)fromMapMap:(NSDictionary<NSString *, id> *)map __attribute__((swift_name("fromMap(map:)")));
@end
...
- (DOSCRequestToPresentParticipant *)doCopyId:(NSString *)id name:(NSString *)name __attribute__((swift_name("doCopy(id:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
...
- (instancetype)initWithUserId:(NSString *)userId displayName:(NSString *)displayName read:(BOOL)read pluginId:(NSString * _Nullable)pluginId link:(NSString *)link time:(NSString *)time __attribute__((swift_name("init(userId:displayName:read:pluginId:link:time:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithUserId:(NSString *)userId displayName:(NSString *)displayName read:(BOOL)read pluginId:(NSString * _Nullable)pluginId type:(DOSCDyteMessageType *)type time:(NSString *)time __attribute__((swift_name("init(userId:displayName:read:pluginId:type:time:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (readonly) NSString *link __attribute__((swift_name("link")));
@end
...
- (void)acceptAllRequests __attribute__((swift_name("acceptAllRequests()")));
- (void)acceptRequestPeer:(DOSCLiveStreamStageRequestPeer *)peer __attribute__((swift_name("acceptRequest(peer:)")));
- (void)acceptStageRequest __attribute__((swift_name("acceptStageRequest()")));
- (void)getStagePeersOnPeersLoaded:(void (^)(NSArray<DOSCLiveStreamStagePeer *> *))onPeersLoaded __attribute__((swift_name("getStagePeers(onPeersLoaded:)")));
- (void)getStageRequestPeersOnPeersLoaded:(void (^)(NSArray<DOSCLiveStreamStageRequestPeer *> *))onPeersLoaded __attribute__((swift_name("getStageRequestPeers(onPeersLoaded:)")));
- (void)joinStage __attribute__((swift_name("joinStage()")));
- (void)leaveStage __attribute__((swift_name("leaveStage()")));
- (void)rejectAllRequests __attribute__((swift_name("rejectAllRequests()")));
- (void)rejectRequestPeer:(DOSCLiveStreamStageRequestPeer *)peer __attribute__((swift_name("rejectRequest(peer:)")));
- (void)start __attribute__((swift_name("start()")));
- (void)stop __attribute__((swift_name("stop()")));
...
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
@property (readonly) int64_t meetingStartedTimeInEpox __attribute__((swift_name("meetingStartedTimeInEpox")));
...
@property (class, readonly, getter=companion) DOSCDyteWaitlistedParticipantCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteWaitlistedParticipant.Companion")))
@interface DOSCDyteWaitlistedParticipantCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteWaitlistedParticipantCompanion *shared __attribute__((swift_name("shared")));
@end
...
__attribute__((swift_name("IPollsSocketHandler")))
@protocol DOSCIPollsSocketHandler
@required
...
- (void)handlePollWebSocketPoll:(DOSCWebSocketPoll *)webSocketPoll updateUI:(BOOL)updateUI __attribute__((swift_name("handlePoll(webSocketPoll:updateUI:)")));
...
*/
- (void)voteDytePollMessage:(DOSCDytePollMessage *)dytePollMessage dytePollOption:(DOSCDytePollOption *)dytePollOption completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("vote(dytePollMessage:dytePollOption:completionHandler:)")));
@property (readonly) BOOL isUsingSocketService __attribute__((swift_name("isUsingSocketService")));
@property (readonly) NSArray<DOSCDytePollMessage *> *polls __attribute__((swift_name("polls")));
@end
...
@required
- (DOSCWebrtcAudioStreamTrack * _Nullable)createAudioTrack __attribute__((swift_name("createAudioTrack()")));
- (DOSCWebrtcVideoStreamTrack * _Nullable)createVideoTrack __attribute__((swift_name("createVideoTrack()")));
- (void)dispose __attribute__((swift_name("dispose()")));
- (DOSCWebrtcMediaStream * _Nullable)getAudioStream __attribute__((swift_name("getAudioStream()")));
- (DOSCWebrtcMediaStream * _Nullable)getVideoStream __attribute__((swift_name("getVideoStream()")));
- (DOSCWebrtcVideoStreamTrack * _Nullable)getVideoTrack __attribute__((swift_name("getVideoTrack()")));
- (void)onCameraClosed __attribute__((swift_name("onCameraClosed()")));
- (void)resumeVideo __attribute__((swift_name("resumeVideo()")));
- (void)setLoggerLogger:(id<DOSCILoggerController>)logger __attribute__((swift_name("setLogger(logger:)")));
...
__attribute__((swift_name("DyteCommonMediaUtils")))
@interface DOSCDyteCommonMediaUtils : DOSCBase <DOSCIDyteCommonMediaUtils>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (DOSCWebrtcAudioStreamTrack * _Nullable)createAudioTrack __attribute__((swift_name("createAudioTrack()")));
- (DOSCWebrtcVideoStreamTrack * _Nullable)createVideoTrack __attribute__((swift_name("createVideoTrack()")));
...
@required
- (void)handlePauseConsumerId:(NSString *)id __attribute__((swift_name("handlePauseConsumer(id:)")));
- (void)handleResumeConsumerId:(NSString *)id __attribute__((swift_name("handleResumeConsumer(id:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)leaveCallWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("leaveCall(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)muteSelfAudioWithCompletionHandler:(void (^)(DOSCBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("muteSelfAudio(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)muteSelfVideoWithCompletionHandler:(void (^)(DOSCBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("muteSelfVideo(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)produceMediaWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("produceMedia(completionHandler:)")));
- (void)switchCamera __attribute__((swift_name("switchCamera()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)unmuteSelfAudioWithCompletionHandler:(void (^)(DOSCBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("unmuteSelfAudio(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)unmuteSelfVideoWithCompletionHandler:(void (^)(DOSCBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("unmuteSelfVideo(completionHandler:)")));
@end

__attribute__((swift_name("IDyteHive")))
@protocol DOSCIDyteHive <DOSCIDyteSFUUtils>
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)cleanupConsumersPeerId:(NSString * _Nullable)peerId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("cleanupConsumers(peerId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)closeConsumerConsumerId:(NSString *)consumerId force:(DOSCBoolean * _Nullable)force completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("closeConsumer(consumerId:force:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)closeConsumersConsumerIds:(NSArray<NSString *> *)consumerIds force:(DOSCBoolean * _Nullable)force completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("closeConsumers(consumerIds:force:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)consumePeerProducingPeerId:(NSString *)producingPeerId completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("consumePeer(producingPeerId:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createWebRtcTransportProdModel:(DOSCWebRtcCreateTransportModel * _Nullable)model iceServers:(NSArray<DOSCIceServerData *> *)iceServers completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("createWebRtcTransportProd(model:iceServers:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createWebRtcTransportRecvModel:(DOSCWebRtcCreateTransportModel * _Nullable)model iceServers:(NSArray<DOSCIceServerData *> *)iceServers completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("createWebRtcTransportRecv(model:iceServers:completionHandler:)")));
- (void)disableCam __attribute__((swift_name("disableCam()")));
- (void)disableMic __attribute__((swift_name("disableMic()")));
- (void)disableScreenShare __attribute__((swift_name("disableScreenShare()")));
- (NSDictionary<NSString *, DOSCDyte_media_clientHiveConsumer *> *)getConsumers __attribute__((swift_name("getConsumers()")));
- (id<DOSCKotlinx_coroutines_coreMutableSharedFlow>)getObserverFlow __attribute__((swift_name("getObserverFlow()")));
- (DOSCKotlinPair<DOSCWebrtcAudioStreamTrack *, DOSCWebrtcVideoStreamTrack *> *)getSelfTrack __attribute__((swift_name("getSelfTrack()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)handleNewConsumerHiveConsumerOptions:(DOSCDyte_media_clientHiveConsumerOptions *)hiveConsumerOptions completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("handleNewConsumer(hiveConsumerOptions:completionHandler:)")));
- (void)doInit __attribute__((swift_name("doInit()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pauseCamWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("pauseCam(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pauseMicWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("pauseMic(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)pauseProducerType:(NSString *)type completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("pauseProducer(type:completionHandler:)")));
- (void)removeProducerType:(NSString *)type stopTracks:(DOSCBoolean * _Nullable)stopTracks __attribute__((swift_name("removeProducer(type:stopTracks:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)replaceTrackType:(NSString *)type track:(DOSCWebrtcMediaStreamTrack *)track completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("replaceTrack(type:track:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)resetVideoProducersVideoTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)videoTrack screenShareTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)screenShareTrack completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("resetVideoProducers(videoTrack:screenShareTrack:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)resumeCamWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("resumeCam(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)resumeMicWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("resumeMic(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)resumeProducerType:(NSString *)type completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("resumeProducer(type:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setupTransportsIceServers:(NSArray<DOSCIceServerData *> * _Nullable)iceServers completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("setupTransports(iceServers:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)shareCamVideoTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)videoTrack completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("shareCam(videoTrack:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)shareMicAudioTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)audioTrack completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("shareMic(audioTrack:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)shareScreenVideoTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)videoTrack audioTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)audioTrack completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("shareScreen(videoTrack:audioTrack:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)stopAllProducersWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("stopAllProducers(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)stopAllTransportsWithCompletionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("stopAllTransports(completionHandler:)")));
@property (readonly) DOSCMutableDictionary<NSString *, NSString *> *producerIdToConsumerIdMap __attribute__((swift_name("producerIdToConsumerIdMap")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteHive")))
@interface DOSCDyteHive : DOSCBase <DOSCIDyteHive>
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createProducerProducerType:(DOSCProducerType *)producerType producerOptions:(DOSCDyte_media_clientHiveProducerOptions *)producerOptions onDisconnect:(void (^)(void))onDisconnect completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("createProducer(producerType:producerOptions:onDisconnect:completionHandler:)")));
...
- (void)disableMic __attribute__((swift_name("disableMic()")));
- (void)disableScreenShare __attribute__((swift_name("disableScreenShare()")));
- (DOSCMutableDictionary<NSString *, DOSCDyte_media_clientHiveConsumer *> *)getConsumers __attribute__((swift_name("getConsumers()")));
- (id<DOSCKotlinx_coroutines_coreMutableSharedFlow>)getObserverFlow __attribute__((swift_name("getObserverFlow()")));
- (DOSCMutableDictionary<NSString *, DOSCDyte_media_clientHiveProducer *> *)getProducers __attribute__((swift_name("getProducers()")));
- (DOSCKotlinPair<DOSCWebrtcAudioStreamTrack *, DOSCWebrtcVideoStreamTrack *> *)getSelfTrack __attribute__((swift_name("getSelfTrack()")));
- (void)handleCloseConsumerConsumerId:(NSString *)consumerId __attribute__((swift_name("handleCloseConsumer(consumerId:)")));
...
- (instancetype)initWithLogger:(id<DOSCILoggerController>)logger __attribute__((swift_name("init(logger:)"))) __attribute__((objc_designated_initializer));
- (void)traceErrorMessage:(NSString *)message __attribute__((swift_name("traceError(message:)")));
- (void)traceLogMessage:(NSString *)message __attribute__((swift_name("traceLog(message:)")));
- (void)traceWarningMessage:(NSString *)message __attribute__((swift_name("traceWarning(message:)")));
@end
...
@property (class, readonly) NSArray<DOSCLogStatus *> *entries __attribute__((swift_name("entries")));
@end
...
- (instancetype)initWithHiddenParticipant:(DOSCBoolean * _Nullable)hiddenParticipant recordere:(DOSCBoolean * _Nullable)recordere webinarHiddenParticipant:(DOSCBoolean * _Nullable)webinarHiddenParticipant __attribute__((swift_name("init(hiddenParticipant:recordere:webinarHiddenParticipant:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCMeetingPeerFlagsCompanion *companion __attribute__((swift_name("companion")));
- (DOSCMeetingPeerFlags *)doCopyHiddenParticipant:(DOSCBoolean * _Nullable)hiddenParticipant recordere:(DOSCBoolean * _Nullable)recordere webinarHiddenParticipant:(DOSCBoolean * _Nullable)webinarHiddenParticipant __attribute__((swift_name("doCopy(hiddenParticipant:recordere:webinarHiddenParticipant:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString * _Nullable presetName __attribute__((swift_name("presetName")));
...
@property DOSCMeetingPeerMetadata *participantMetadata __attribute__((swift_name("participantMetadata")));
...
- (instancetype)initWithPeerIds:(NSArray<NSString *> * _Nullable)peerIds compulsoryPeers:(NSArray<NSString *> * _Nullable)compulsoryPeers __attribute__((swift_name("init(peerIds:compulsoryPeers:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (DOSCWebSocketSelectedPeersModel *)doCopyPeerIds:(NSArray<NSString *> * _Nullable)peerIds compulsoryPeers:(NSArray<NSString *> * _Nullable)compulsoryPeers __attribute__((swift_name("doCopy(peerIds:compulsoryPeers:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSArray<NSString *> * _Nullable compulsoryPeers __attribute__((swift_name("compulsoryPeers")));
...
- (DOSCWebSocketJoinRoomModel *)doCopyWaitlisted:(DOSCBoolean * _Nullable)waitlisted peers:(NSArray<DOSCWebSocketMeetingPeerUser *> * _Nullable)peers waitlistedPeers:(NSArray<DOSCWebSocketMeetingPeerUser *> * _Nullable)waitlistedPeers requestToJoinPeersList:(NSArray<DOSCRequestToPresentParticipant *> * _Nullable)requestToJoinPeersList startedAt:(NSString * _Nullable)startedAt pinnedPeerId:(NSString * _Nullable)pinnedPeerId __attribute__((swift_name("doCopy(waitlisted:peers:waitlistedPeers:requestToJoinPeersList:startedAt:pinnedPeerId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<DOSCWebSocketMeetingPeerUser *> * _Nullable peers __attribute__((swift_name("peers")));
@property (readonly) NSString * _Nullable pinnedPeerId __attribute__((swift_name("pinnedPeerId")));
@property (readonly) NSArray<DOSCRequestToPresentParticipant *> * _Nullable requestToJoinPeersList __attribute__((swift_name("requestToJoinPeersList")));
...
@required
- (void)renderTrack:(DOSCWebrtcMediaStreamTrack *)track __attribute__((swift_name("render(track:)")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getIpDetailsPeerId:(NSString *)peerId completionHandler:(void (^)(DOSCIpDetailsResponsePayload * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getIpDetails(peerId:completionHandler:)")));
...
- (DOSCMediaPermissions *)doCopyVideo:(DOSCVideoPermissions *)video audioPermission:(DOSCDyteMediaPermission *)audioPermission __attribute__((swift_name("doCopy(video:audioPermission:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithTitle:(NSString *)title roomNodeLink:(NSString * _Nullable)roomNodeLink useHive:(DOSCBoolean * _Nullable)useHive __attribute__((swift_name("init(title:roomNodeLink:useHive:)"))) __attribute__((objc_designated_initializer));
- (DOSCMeetingSessionInfo *)doCopyTitle:(NSString *)title roomNodeLink:(NSString * _Nullable)roomNodeLink useHive:(DOSCBoolean * _Nullable)useHive __attribute__((swift_name("doCopy(title:roomNodeLink:useHive:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable roomNodeLink __attribute__((swift_name("roomNodeLink")));
...
@required
- (void)onJoinRequestAcceptedPeer:(DOSCLiveStreamStagePeer *)peer __attribute__((swift_name("onJoinRequestAccepted(peer:)")));
- (void)onJoinRequestRejectedPeer:(DOSCLiveStreamStagePeer *)peer __attribute__((swift_name("onJoinRequestRejected(peer:)")));
...
- (void)onStageRequestsUpdatedRequests:(NSArray<DOSCLiveStreamStageRequestPeer *> *)requests __attribute__((swift_name("onStageRequestsUpdated(requests:)")));
...
- (void)onScreenShareEndedParticipant:(DOSCDyteScreenShareMeetingParticipant *)participant __attribute__((swift_name("onScreenShareEnded(participant:)")));
- (void)onScreenShareStartedParticipant:(DOSCDyteScreenShareMeetingParticipant *)participant __attribute__((swift_name("onScreenShareStarted(participant:)")));
...
- (void)onRemovedFromMeeting __attribute__((swift_name("onRemovedFromMeeting()")));
- (void)onRoomMessageMessage:(NSString *)message __attribute__((swift_name("onRoomMessage(message:)")));
...
__attribute__((swift_name("DyteWebinarEventsListener")))
@protocol DOSCDyteWebinarEventsListener
@required
- (void)onAddedToStage __attribute__((swift_name("onAddedToStage()")));
- (void)onPresentRequestClosedParticipant:(DOSCRequestToPresentParticipant *)participant __attribute__((swift_name("onPresentRequestClosed(participant:)")));
- (void)onPresentRequestReceived __attribute__((swift_name("onPresentRequestReceived()")));
- (void)onPresetRequestAcceptedParticipant:(DOSCRequestToPresentParticipant *)participant __attribute__((swift_name("onPresetRequestAccepted(participant:)")));
- (void)onPresetRequestAddedParticipant:(DOSCRequestToPresentParticipant *)participant __attribute__((swift_name("onPresetRequestAdded(participant:)")));
- (void)onPresetRequestRejectedParticipant:(DOSCRequestToPresentParticipant *)participant __attribute__((swift_name("onPresetRequestRejected(participant:)")));
- (void)onPresetRequestWithdrawnParticipant:(DOSCRequestToPresentParticipant *)participant __attribute__((swift_name("onPresetRequestWithdrawn(participant:)")));
...
- (UIView *)getScreenShareViewParticipant:(DOSCDyteScreenShareMeetingParticipant *)participant __attribute__((swift_name("getScreenShareView(participant:)")));
...
__attribute__((swift_name("WebrtcMediaStreamTrack")))
@interface DOSCWebrtcMediaStreamTrack : DOSCBase
@property (class, readonly, getter=companion) DOSCWebrtcMediaStreamTrackCompanion *companion __attribute__((swift_name("companion")));
...
@property (readonly) DOSCWebrtcMediaStreamTrackKind *kind __attribute__((swift_name("kind")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcVideoStreamTrack")))
@interface DOSCWebrtcVideoStreamTrack : DOSCWebrtcMediaStreamTrack
...
- (DOSCWebrtcDataChannel * _Nullable)getDataChannelLabel:(NSString *)label __attribute__((swift_name("getDataChannel(label:)")));
- (DOSCMutableDictionary<NSString *, DOSCWebrtcDataChannel *> *)getDataChannels __attribute__((swift_name("getDataChannels()")));
- (DOSCWebrtcRtpTransceiverDirection *)getDirection __attribute__((swift_name("getDirection()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setRemoteOfferOffer:(DOSCWebrtcSessionDescription *)offer completionHandler:(void (^)(DOSCWebrtcSessionDescription * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("setRemoteOffer(offer:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)updateIceServersIceServers:(NSArray<DOSCWebrtcIceServer *> *)iceServers completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("updateIceServers(iceServers:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcAudioStreamTrack")))
@interface DOSCWebrtcAudioStreamTrack : DOSCWebrtcMediaStreamTrack
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcMediaStream")))
@interface DOSCWebrtcMediaStream : DOSCBase
- (void)addTrackTrack:(DOSCWebrtcMediaStreamTrack *)track __attribute__((swift_name("addTrack(track:)")));
- (DOSCWebrtcMediaStreamTrack * _Nullable)getTrackByIdId:(NSString *)id __attribute__((swift_name("getTrackById(id:)")));
- (void)release_ __attribute__((swift_name("release()")));
- (void)removeTrackTrack:(DOSCWebrtcMediaStreamTrack *)track __attribute__((swift_name("removeTrack(track:)")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) RTCMediaStream * _Nullable ios __attribute__((swift_name("ios")));
@property (readonly) NSArray<DOSCWebrtcMediaStreamTrack *> *tracks __attribute__((swift_name("tracks")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Dyte_media_clientHiveConsumer")))
@interface DOSCDyte_media_clientHiveConsumer : DOSCBase
- (instancetype)initWithOptions:(DOSCDyte_media_clientHiveInternalConsumerOptions *)options coroutineScope:(id<DOSCKotlinx_coroutines_coreCoroutineScope>)coroutineScope logger:(id<DOSCDyte_media_clientIMediaClientLogger>)logger __attribute__((swift_name("init(options:coroutineScope:logger:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)closeReason:(NSString *)reason completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("close(reason:completionHandler:)")));
- (NSDictionary<NSString *, id> * _Nullable)getAppData __attribute__((swift_name("getAppData()")));
- (BOOL)getClosed __attribute__((swift_name("getClosed()")));
- (NSString *)getId __attribute__((swift_name("getId()")));
- (DOSCWebrtcMediaStreamTrackKind *)getKind __attribute__((swift_name("getKind()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getStatsWithCompletionHandler:(void (^)(NSArray<DOSCWebrtcRtcStatsReport *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getStats(completionHandler:)")));
...
@property (readonly) NSArray<DOSCWebrtcCommonRtpEncodingParameters *> * _Nullable encodings __attribute__((swift_name("encodings")));
@property (readonly) DOSCBoolean * _Nullable stopTracks __attribute__((swift_name("stopTracks")));
@property (readonly) DOSCWebrtcMediaStream *stream __attribute__((swift_name("stream")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)replaceTrackTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)track completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("replaceTrack(track:completionHandler:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)setRtpEncodingParametersParams:(DOSCWebrtcCommonRtpEncodingParameters *)params completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("setRtpEncodingParameters(params:completionHandler:)")));
@property (readonly) id<DOSCKotlinx_coroutines_coreMutableSharedFlow> observer __attribute__((swift_name("observer")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcMediaStreamTrack.Companion")))
@interface DOSCWebrtcMediaStreamTrackCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCWebrtcMediaStreamTrackCompanion *shared __attribute__((swift_name("shared")));
- (DOSCWebrtcMediaStreamTrack *)createCommonIos:(RTCMediaStreamTrack *)ios __attribute__((swift_name("createCommon(ios:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcMediaStreamTrackKind")))
@interface DOSCWebrtcMediaStreamTrackKind : DOSCKotlinEnum<DOSCWebrtcMediaStreamTrackKind *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DOSCWebrtcMediaStreamTrackKind *audio __attribute__((swift_name("audio")));
@property (class, readonly) DOSCWebrtcMediaStreamTrackKind *video __attribute__((swift_name("video")));
+ (DOSCKotlinArray<DOSCWebrtcMediaStreamTrackKind *> *)values __attribute__((swift_name("values()")));
@end
...
@property (readonly) NSDictionary<NSString *, id> * _Nullable appData __attribute__((swift_name("appData")));
@property (readonly) NSArray<DOSCWebrtcIceServer *> * _Nullable iceServers __attribute__((swift_name("iceServers")));
@property (readonly) DOSCWebrtcIceTransportPolicy * _Nullable iceTransportPolicy __attribute__((swift_name("iceTransportPolicy")));
...
- (instancetype)initWithId:(NSString * _Nullable)id direction:(DOSCWebrtcRtpTransceiverDirection *)direction handlerFactory:(DOSCDyte_media_clientHiveHandlerInterface *(^ _Nullable)(void))handlerFactory iceServers:(NSArray<DOSCWebrtcIceServer *> *)iceServers iceTransportPolicy:(DOSCWebrtcIceTransportPolicy * _Nullable)iceTransportPolicy additionalSettings:(DOSCMutableDictionary<NSString *, id> * _Nullable)additionalSettings proprietaryConstraints:(id _Nullable)proprietaryConstraints appData:(NSDictionary<NSString *, id> * _Nullable)appData __attribute__((swift_name("init(id:direction:handlerFactory:iceServers:iceTransportPolicy:additionalSettings:proprietaryConstraints:appData:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithIceServers:(NSArray<DOSCWebrtcIceServer *> * _Nullable)iceServers iceTransportPolicy:(DOSCWebrtcIceTransportPolicy * _Nullable)iceTransportPolicy additionalSettings:(DOSCMutableDictionary<NSString *, id> * _Nullable)additionalSettings proprietaryConstraints:(id _Nullable)proprietaryConstraints appData:(NSDictionary<NSString *, id> * _Nullable)appData __attribute__((swift_name("init(iceServers:iceTransportPolicy:additionalSettings:proprietaryConstraints:appData:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (readonly) DOSCMutableDictionary<NSString *, id> * _Nullable additionalSettings __attribute__((swift_name("additionalSettings")));
@property (readonly) NSDictionary<NSString *, id> * _Nullable appData __attribute__((swift_name("appData")));
@property (readonly) DOSCWebrtcRtpTransceiverDirection *direction __attribute__((swift_name("direction")));
...
@property (readonly) NSArray<DOSCWebrtcIceServer *> *iceServers __attribute__((swift_name("iceServers")));
@property (readonly) DOSCWebrtcIceTransportPolicy * _Nullable iceTransportPolicy __attribute__((swift_name("iceTransportPolicy")));
@property (readonly) NSString * _Nullable id __attribute__((swift_name("id")));
@property (readonly) id _Nullable proprietaryConstraints __attribute__((swift_name("proprietaryConstraints")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcDataChannel")))
@interface DOSCWebrtcDataChannel : DOSCBase
...
@property (readonly) DOSCWebrtcDataChannelState *readyState __attribute__((swift_name("readyState")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtpTransceiverDirection")))
@interface DOSCWebrtcRtpTransceiverDirection : DOSCKotlinEnum<DOSCWebrtcRtpTransceiverDirection *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DOSCWebrtcRtpTransceiverDirection *sendrecv __attribute__((swift_name("sendrecv")));
@property (class, readonly) DOSCWebrtcRtpTransceiverDirection *sendonly __attribute__((swift_name("sendonly")));
@property (class, readonly) DOSCWebrtcRtpTransceiverDirection *recvonly __attribute__((swift_name("recvonly")));
@property (class, readonly) DOSCWebrtcRtpTransceiverDirection *inactive __attribute__((swift_name("inactive")));
@property (class, readonly) DOSCWebrtcRtpTransceiverDirection *stopped __attribute__((swift_name("stopped")));
+ (DOSCKotlinArray<DOSCWebrtcRtpTransceiverDirection *> *)values __attribute__((swift_name("values()")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getReceiverStatsLocalId:(NSString *)localId completionHandler:(void (^)(NSArray<DOSCWebrtcRtcStatsReport *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getReceiverStats(localId:completionHandler:)")));
- (NSArray<DOSCWebrtcRtcStatsReport *> *)getSenderStatsLocalId:(NSString *)localId __attribute__((swift_name("getSenderStats(localId:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)replaceTrackLocalId:(NSString *)localId track:(DOSCWebrtcMediaStreamTrack * _Nullable)track completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("replaceTrack(localId:track:completionHandler:)")));
...
*/
- (void)updateIceServersIceServers:(NSArray<DOSCWebrtcIceServer *> *)iceServers completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("updateIceServers(iceServers:completionHandler:)")));
@property (readonly) DOSCMutableDictionary<NSString *, DOSCWebrtcRtpTransceiver *> *mapMidTransceiver __attribute__((swift_name("mapMidTransceiver")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtcStatsReport")))
@interface DOSCWebrtcRtcStatsReport : DOSCBase
...
@property (readonly) NSDictionary<NSString *, DOSCWebrtcRtcStats *> *stats __attribute__((swift_name("stats")));
...
@interface DOSCWebrtcSessionDescription : DOSCBase
- (instancetype)initWithType:(DOSCWebrtcSessionDescriptionType *)type sdp:(NSString *)sdp __attribute__((swift_name("init(type:sdp:)"))) __attribute__((objc_designated_initializer));
- (DOSCWebrtcSessionDescription *)doCopyType:(DOSCWebrtcSessionDescriptionType *)type sdp:(NSString *)sdp __attribute__((swift_name("doCopy(type:sdp:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *sdp __attribute__((swift_name("sdp")));
@property (readonly) DOSCWebrtcSessionDescriptionType *type __attribute__((swift_name("type")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcIceServer")))
@interface DOSCWebrtcIceServer : DOSCBase
- (instancetype)initWithUrls:(NSArray<NSString *> *)urls username:(NSString *)username password:(NSString *)password tlsCertPolicy:(DOSCWebrtcTlsCertPolicy *)tlsCertPolicy hostname:(NSString *)hostname tlsAlpnProtocols:(NSArray<NSString *> * _Nullable)tlsAlpnProtocols tlsEllipticCurves:(NSArray<NSString *> * _Nullable)tlsEllipticCurves __attribute__((swift_name("init(urls:username:password:tlsCertPolicy:hostname:tlsAlpnProtocols:tlsEllipticCurves:)"))) __attribute__((objc_designated_initializer));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcCommonRtpEncodingParameters")))
@interface DOSCWebrtcCommonRtpEncodingParameters : DOSCBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcIceTransportPolicy")))
@interface DOSCWebrtcIceTransportPolicy : DOSCKotlinEnum<DOSCWebrtcIceTransportPolicy *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DOSCWebrtcIceTransportPolicy *none __attribute__((swift_name("none")));
@property (class, readonly) DOSCWebrtcIceTransportPolicy *relay __attribute__((swift_name("relay")));
@property (class, readonly) DOSCWebrtcIceTransportPolicy *nohost __attribute__((swift_name("nohost")));
@property (class, readonly) DOSCWebrtcIceTransportPolicy *all __attribute__((swift_name("all")));
+ (DOSCKotlinArray<DOSCWebrtcIceTransportPolicy *> *)values __attribute__((swift_name("values()")));
@end

__attribute__((swift_name("Kotlinx_coroutines_coreSelectClause1")))
@protocol DOSCKotlinx_coroutines_coreSelectClause1
@required
- (void)registerSelectClause1Select:(id<DOSCKotlinx_coroutines_coreSelectInstance>)select block:(id<DOSCKotlinSuspendFunction1>)block __attribute__((swift_name("registerSelectClause1(select:block:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcDataChannelState")))
@interface DOSCWebrtcDataChannelState : DOSCKotlinEnum<DOSCWebrtcDataChannelState *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DOSCWebrtcDataChannelState *connecting __attribute__((swift_name("connecting")));
@property (class, readonly) DOSCWebrtcDataChannelState *open __attribute__((swift_name("open")));
@property (class, readonly) DOSCWebrtcDataChannelState *closing __attribute__((swift_name("closing")));
@property (class, readonly) DOSCWebrtcDataChannelState *closed __attribute__((swift_name("closed")));
+ (DOSCKotlinArray<DOSCWebrtcDataChannelState *> *)values __attribute__((swift_name("values()")));
@end
...
- (instancetype)initWithTrack:(DOSCWebrtcMediaStreamTrack *)track stream:(DOSCWebrtcMediaStream *)stream screenShare:(DOSCBoolean * _Nullable)screenShare encodings:(NSArray<DOSCWebrtcCommonRtpEncodingParameters *> * _Nullable)encodings codecs:(NSArray<DOSCWebrtcRtpCodecParameters *> * _Nullable)codecs codecOptions:(DOSCDyte_media_clientHiveCodecOptions * _Nullable)codecOptions __attribute__((swift_name("init(track:stream:screenShare:encodings:codecs:codecOptions:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCDyte_media_clientHiveCodecOptions * _Nullable codecOptions __attribute__((swift_name("codecOptions")));
@property (readonly) NSArray<DOSCWebrtcRtpCodecParameters *> * _Nullable codecs __attribute__((swift_name("codecs")));
@property (readonly) NSArray<DOSCWebrtcCommonRtpEncodingParameters *> * _Nullable encodings __attribute__((swift_name("encodings")));
@property (readonly) DOSCBoolean * _Nullable screenShare __attribute__((swift_name("screenShare")));
@property (readonly) DOSCWebrtcMediaStream *stream __attribute__((swift_name("stream")));
@property (readonly) DOSCWebrtcMediaStreamTrack *track __attribute__((swift_name("track")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtpTransceiver")))
@interface DOSCWebrtcRtpTransceiver : DOSCBase
- (instancetype)initWithNative:(RTCRtpTransceiver *)native senderTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)senderTrack receiverTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)receiverTrack __attribute__((swift_name("init(native:senderTrack:receiverTrack:)"))) __attribute__((objc_designated_initializer));
- (void)stop __attribute__((swift_name("stop()")));
@property (readonly) DOSCWebrtcRtpTransceiverDirection * _Nullable currentDirection __attribute__((swift_name("currentDirection")));
@property DOSCWebrtcRtpTransceiverDirection *direction __attribute__((swift_name("direction")));
...
@property (readonly) DOSCWebrtcRtpReceiver *receiver __attribute__((swift_name("receiver")));
@property (readonly) DOSCWebrtcRtpSender *sender __attribute__((swift_name("sender")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtcStats")))
@interface DOSCWebrtcRtcStats : DOSCBase
- (DOSCWebrtcRtcStats *)doCopyTimestampUs:(int64_t)timestampUs type:(NSString *)type id:(NSString *)id members:(NSDictionary<NSString *, id> *)members __attribute__((swift_name("doCopy(timestampUs:type:id:members:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcSessionDescriptionType")))
@interface DOSCWebrtcSessionDescriptionType : DOSCKotlinEnum<DOSCWebrtcSessionDescriptionType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DOSCWebrtcSessionDescriptionType *offer __attribute__((swift_name("offer")));
@property (class, readonly) DOSCWebrtcSessionDescriptionType *pranswer __attribute__((swift_name("pranswer")));
@property (class, readonly) DOSCWebrtcSessionDescriptionType *answer __attribute__((swift_name("answer")));
@property (class, readonly) DOSCWebrtcSessionDescriptionType *rollback __attribute__((swift_name("rollback")));
+ (DOSCKotlinArray<DOSCWebrtcSessionDescriptionType *> *)values __attribute__((swift_name("values()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcTlsCertPolicy")))
@interface DOSCWebrtcTlsCertPolicy : DOSCKotlinEnum<DOSCWebrtcTlsCertPolicy *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) DOSCWebrtcTlsCertPolicy *tlscertpolicysecure __attribute__((swift_name("tlscertpolicysecure")));
@property (class, readonly) DOSCWebrtcTlsCertPolicy *tlscertpolicyinsecurenocheck __attribute__((swift_name("tlscertpolicyinsecurenocheck")));
+ (DOSCKotlinArray<DOSCWebrtcTlsCertPolicy *> *)values __attribute__((swift_name("values()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtpCodecParameters")))
@interface DOSCWebrtcRtpCodecParameters : DOSCBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtpReceiver")))
@interface DOSCWebrtcRtpReceiver : DOSCBase
- (instancetype)initWithNative:(RTCRtpReceiver *)native track:(DOSCWebrtcMediaStreamTrack * _Nullable)track __attribute__((swift_name("init(native:track:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) RTCRtpReceiver *native __attribute__((swift_name("native")));
@property (readonly) DOSCWebrtcRtpParameters *parameters __attribute__((swift_name("parameters")));
@property (readonly) DOSCWebrtcMediaStreamTrack * _Nullable track __attribute__((swift_name("track")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtpSender")))
@interface DOSCWebrtcRtpSender : DOSCBase
- (instancetype)initWithNative:(RTCRtpSender *)native track:(DOSCWebrtcMediaStreamTrack * _Nullable)track __attribute__((swift_name("init(native:track:)"))) __attribute__((objc_designated_initializer));
...
*/
- (void)replaceTrackTrack:(DOSCWebrtcMediaStreamTrack * _Nullable)track completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("replaceTrack(track:completionHandler:)")));
@property (readonly) DOSCWebrtcDtmfSender * _Nullable dtmf __attribute__((swift_name("dtmf")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) RTCRtpSender *native __attribute__((swift_name("native")));
@property DOSCWebrtcRtpParameters *parameters __attribute__((swift_name("parameters")));
@property (readonly) DOSCWebrtcMediaStreamTrack * _Nullable track __attribute__((swift_name("track")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtpParameters")))
@interface DOSCWebrtcRtpParameters : DOSCBase
...
@property NSMutableArray<DOSCWebrtcRtpCodecParameters *> *codecs __attribute__((swift_name("codecs")));
@property NSArray<DOSCWebrtcRtpEncodingParameters *> *encodings __attribute__((swift_name("encodings")));
@property NSMutableArray<DOSCWebrtcHeaderExtension *> *headerExtension __attribute__((swift_name("headerExtension")));
@property (readonly) RTCRtpParameters *native __attribute__((swift_name("native")));
@property (readonly) DOSCWebrtcRtcpParameters *rtcp __attribute__((swift_name("rtcp")));
@property NSString *transactionId __attribute__((swift_name("transactionId")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcDtmfSender")))
@interface DOSCWebrtcDtmfSender : DOSCBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtpEncodingParameters")))
@interface DOSCWebrtcRtpEncodingParameters : DOSCBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcHeaderExtension")))
@interface DOSCWebrtcHeaderExtension : DOSCBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebrtcRtcpParameters")))
@interface DOSCWebrtcRtcpParameters : DOSCBase
