...
- (void)setMeetingStartedTimeTime:(int64_t)time __attribute__((swift_name("setMeetingStartedTime(time:)")));
...
- (instancetype)initWithSelf:(DOSCDyteSelfParticipant *)self scope:(id<DOSCKotlinx_coroutines_coreCoroutineScope>)scope __attribute__((swift_name("init(self:scope:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)doInit __attribute__((swift_name("doInit()")));
 ...
 * @note This property has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
@property (readonly) id<DOSCKotlinx_coroutines_coreCoroutineScope> scope __attribute__((swift_name("scope")));
@property (readonly) DOSCStageStatus *stageStatus __attribute__((swift_name("stageStatus")));
