...
- (instancetype)initWithGridPagesInfo:(DOSCGridPagesInfo *)gridPagesInfo __attribute__((swift_name("init(gridPagesInfo:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCGridPagesInfo *gridPagesInfo __attribute__((swift_name("gridPagesInfo")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GridPagesInfo")))
@interface DOSCGridPagesInfo : DOSCBase
- (instancetype)initWithPageCount:(int32_t)pageCount currentPageNumber:(int32_t)currentPageNumber isNextPagePossible:(BOOL)isNextPagePossible isPreviousPagePossible:(BOOL)isPreviousPagePossible shouldShowPaginator:(BOOL)shouldShowPaginator __attribute__((swift_name("init(pageCount:currentPageNumber:isNextPagePossible:isPreviousPagePossible:shouldShowPaginator:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (BOOL)component4 __attribute__((swift_name("component4()")));
- (BOOL)component5 __attribute__((swift_name("component5()")));
- (DOSCGridPagesInfo *)doCopyPageCount:(int32_t)pageCount currentPageNumber:(int32_t)currentPageNumber isNextPagePossible:(BOOL)isNextPagePossible isPreviousPagePossible:(BOOL)isPreviousPagePossible shouldShowPaginator:(BOOL)shouldShowPaginator __attribute__((swift_name("doCopy(pageCount:currentPageNumber:isNextPagePossible:isPreviousPagePossible:shouldShowPaginator:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (id)getVideoViewDyteMeetingParticipant:(DOSCDyteMeetingParticipant *)dyteMeetingParticipant __attribute__((swift_name("getVideoView(dyteMeetingParticipant:)")));
...
- (void)onParticipantsUpdatedParticipants:(DOSCDyteRoomParticipants *)participants gridPagesInfo:(DOSCGridPagesInfo *)gridPagesInfo __attribute__((swift_name("onParticipantsUpdated(participants:gridPagesInfo:)")));
...
@required
- (id)getVideoViewParticipant:(DOSCDyteMeetingParticipant *)participant __attribute__((swift_name("getVideoView(participant:)")));
@end;
