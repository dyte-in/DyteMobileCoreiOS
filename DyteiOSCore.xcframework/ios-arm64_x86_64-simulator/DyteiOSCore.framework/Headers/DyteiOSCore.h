 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)activatePluginPlugin:(DOSCDytePlugin *)plugin error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("activatePlugin(plugin:)")));

/**
 * @note This method converts instances of Exception to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (BOOL)deactivatePluginPlugin:(DOSCDytePlugin *)plugin error:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("deactivatePlugin(plugin:)")));
...
- (void)activateCallBack:(void (^)(void))callBack __attribute__((swift_name("activate(callBack:)")));
- (void)deactivateCallBack:(void (^)(void))callBack __attribute__((swift_name("deactivate(callBack:)")));
