...
- (DOSCDyteActionResult *)sendImageMessageImageName:(NSString *)imageName imagePath:(NSString *)imagePath __attribute__((swift_name("sendImageMessage(imageName:imagePath:)")));
...
@property int32_t _defaultRoutechanges __attribute__((swift_name("_defaultRoutechanges")));
...
- (id<DOSCKotlinx_coroutines_coreJob>)runOnIoThreadBlock:(void (^)(void))block __attribute__((swift_name("runOnIoThread(block:)")));
- (id<DOSCKotlinx_coroutines_coreJob>)runOnMainThreadBlock:(void (^)(void))block __attribute__((swift_name("runOnMainThread(block:)")));
@end
