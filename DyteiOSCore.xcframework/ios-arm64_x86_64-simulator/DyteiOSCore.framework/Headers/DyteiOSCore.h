...
- (instancetype)initWithRequests:(NSArray<DOSCDyteStageParticipant *> *)requests __attribute__((swift_name("init(requests:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSArray<DOSCDyteStageParticipant *> *requests __attribute__((swift_name("requests")));
@end
...
- (instancetype)initWithPresentParticipant:(DOSCDyteStageParticipant *)presentParticipant __attribute__((swift_name("init(presentParticipant:)"))) __attribute__((objc_designated_initializer));
@property (readonly) DOSCDyteStageParticipant *presentParticipant __attribute__((swift_name("presentParticipant")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteEventType.OnWebinarRemovedFromStage")))
@interface DOSCDyteEventTypeOnWebinarRemovedFromStage : DOSCDyteEventType
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)onWebinarRemovedFromStage __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteEventTypeOnWebinarRemovedFromStage *shared __attribute__((swift_name("shared")));
@end
...
- (void)addWebinarEventListenerWebinarEventsListener:(id<DOSCDyteStageEventListener>)webinarEventsListener __attribute__((swift_name("addWebinarEventListener(webinarEventsListener:)")));
...
- (void)removeWebinarEventListenerWebinarEventsListener:(id<DOSCDyteStageEventListener>)webinarEventsListener __attribute__((swift_name("removeWebinarEventListener(webinarEventsListener:)")));
...
@interface DOSCDyteStage : DOSCBase
- (void)cancelRequestAccess __attribute__((swift_name("cancelRequestAccess()")));
- (void)denyAccessIds:(NSArray<NSString *> *)ids __attribute__((swift_name("denyAccess(ids:)")));
- (void)grantAccessIds:(NSArray<NSString *> *)ids __attribute__((swift_name("grantAccess(ids:)")));
...
@property (readonly) NSArray<DOSCDyteStageParticipant *> *accessRequests __attribute__((swift_name("accessRequests")));
...
- (void)errorMessage:(NSString *)message e:(DOSCKotlinException *)e __attribute__((swift_name("error(message:e:)")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteStageParticipant")))
@interface DOSCDyteStageParticipant : DOSCBase
- (instancetype)initWithId:(NSString *)id name:(NSString *)name __attribute__((swift_name("init(id:name:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) DOSCDyteStageParticipantCompanion *companion __attribute__((swift_name("companion")));
- (DOSCDyteStageParticipant *)doCopyId:(NSString *)id name:(NSString *)name __attribute__((swift_name("doCopy(id:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSDictionary<NSString *, id> *)toMap __attribute__((swift_name("toMap()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DyteStageParticipant.Companion")))
@interface DOSCDyteStageParticipantCompanion : DOSCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) DOSCDyteStageParticipantCompanion *shared __attribute__((swift_name("shared")));
- (DOSCDyteStageParticipant *)fromMapMap:(NSDictionary<NSString *, id> *)map __attribute__((swift_name("fromMap(map:)")));
- (id<DOSCKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (readonly) NSArray<DOSCDyteStageParticipant *> * _Nullable requestToJoinPeersList __attribute__((swift_name("requestToJoinPeersList")));
...
- (void)onPresentRequestAcceptedParticipant:(DOSCDyteStageParticipant *)participant __attribute__((swift_name("onPresentRequestAccepted(participant:)")));
- (void)onPresentRequestAddedParticipant:(DOSCDyteStageParticipant *)participant __attribute__((swift_name("onPresentRequestAdded(participant:)")));
- (void)onPresentRequestClosedParticipant:(DOSCDyteStageParticipant *)participant __attribute__((swift_name("onPresentRequestClosed(participant:)")));
- (void)onPresentRequestReceived __attribute__((swift_name("onPresentRequestReceived()")));
- (void)onPresentRequestRejectedParticipant:(DOSCDyteStageParticipant *)participant __attribute__((swift_name("onPresentRequestRejected(participant:)")));
- (void)onPresentRequestWithdrawnParticipant:(DOSCDyteStageParticipant *)participant __attribute__((swift_name("onPresentRequestWithdrawn(participant:)")));
- (void)onRemovedFromStage __attribute__((swift_name("onRemovedFromStage()")));
- (void)onStageRequestsUpdatedAccessRequests:(NSArray<DOSCDyteStageParticipant *> *)accessRequests __attribute__((swift_name("onStageRequestsUpdated(accessRequests:)")));
@end
